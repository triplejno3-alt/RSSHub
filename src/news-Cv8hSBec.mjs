...
async function o(a) {
    let o = a.req.query(`limit`) ? Number.parseInt(a.req.query(`limit`), 10) : 50,
        s = new URL(`v1/news`, i).href,
        c = new URL(`news`, e).href,
        { items: l } = await t(s, o);
    return { item: l, title: `Foresight News - 快讯`, link: c, description: `快讯 - Foresight News`, language: `zh-cn`, image: r, icon: n, logo: n, subtitle: `快讯`, author: `Foresight News` };
}
export { a as route };
