...
const s = async (i) => {
        let s = Number.parseInt(i.req.query(`limit`) ?? `24`, 10),
            c = new URL(`case_library/index`, `https://www.adquan.com`).href,
            l = o(await e(c)),
    ...
    c = {
        ...
        radar: [{ source: [`www.adquan.com/case_library/index`], target: `/case_library` }],
        view: i.Articles,
    };
