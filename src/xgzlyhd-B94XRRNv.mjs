import"./ofetch-uhy-qh6X.mjs";import"./config-Cc-zZ5p-.mjs";import"./logger-_vmdpChp.mjs";import"./helpers-C9wXLK0V.mjs";import{t as e}from"./parse-date-DjdQS_Nt.mjs";import{t}from"./got-CKQ7C9HX.mjs";import{jsx as n,jsxs as r}from"hono/jsx/jsx-runtime";import{load as i}from"cheerio";import{renderToString as a}from"hono/jsx/dom/server";const o=`https://xgzlyhd.samr.gov.cn`,s=new URL(`gjjly/message/getMessageList`,o).href,c=new URL(`gjjly/message/getDataList`,o).href,l=new URL(`gjjly/index`,o).href,u={category:`1`,department:`2`},d=async e=>{let{data:n}=await t.post(c,{json:{type:u[e]}});return n.data},f=async(e,t)=>{let n=(await d(e)).filter(e=>e.name===t||e.code===t);if(n.length>0)return n.pop()},p={path:`/samr/xgzlyhd/:category?/:department?`,categories:[`government`],example:`/gov/samr/xgzlyhd`,parameters:{category:`留言类型，见下表，默认为全部`,department:`回复部门，见下表，默认为全部`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},radar:[{source:[`xgzlyhd.samr.gov.cn/gjjly/index`]}],name:`留言咨询`,maintainers:[`nczitzk`],handler:m,url:`xgzlyhd.samr.gov.cn/gjjly/index`,description:`#### 留言类型
...
| 离退办                       | 6bf265ffd1c94fa4a3f1687b03fa908b |`};async function m(c){let{category:u,department:d}=c.req.param(),p=c.req.query(`limit`)?Number.parseInt(c.req.query(`limit`),10):10,m,h;u&&(m=await f(`category`,u)),d&&(h=await f(`department`,d));let{data:g}=await t.post(s,{json:{clyj:``,curPage:`1`,endTime:``,fzsj:h?.code??``,lybt:void 0,lylx:m?.code??``,lynr:``,startTime:``,zj:``}}),_=g.data.data.slice(0,p).map(t=>({title:t.lybt,link:`${l}#${t.zj}`,description:a(t?r(`div`,{children:[r(`span`,{children:[n(`img`,{height:`50px`,src:`https://xgzlyhd.samr.gov.cn/gjjly/img/fd-q-avator.png`}),n(`b`,{children:t.lyr})]}),r(`div`,{children:[n(`h3`,{children:t.lybt}),r(`p`,{children:[`留言日期：`,t.lysj]}),n(`div`,{style:`word-break: break-all;`,children:t.lynr}),n(`br`,{})]}),r(`span`,{children:[n(`img`,{height:`50px`,src:`https://xgzlyhd.samr.gov.cn/gjjly/img/fd-a-avator.png`}),n(`b`,{children:t.fzsjCn})]}),r(`div`,{children:[r(`p`,{children:[`时间：`,t.pubtime]}),n(`div`,{style:`word-break: break-all;`,children:t.clyj})]})]}):null),author:`${t.lyr} ⇄ ${t.fzsjCn}`,category:[t.fzsjCn],guid:`${l}#${t.zj}`,pubDate:e(t.pubtime)})),{data:v}=await t(l),y=i(v),b=`国家市场监督管理总局`,x=y(`title`).text(),S=[m?m.name:void 0,h?h.name:void 0].filter(Boolean).join(` - `),C=new URL(y(`link[rel="icon"]`).prop(`href`),o).href;return{item:_,title:`${b}${x}${S?` - ${S}`:``}`,link:l,description:y(`meta[property="og:description"]`).prop(`content`),language:`zh`,image:new URL(`gjjly/${y(`div.fd-logo img`).prop(`src`)}`,o).href,icon:C,logo:C,subtitle:S,author:b,allowEmpty:!0}}export{p as route};