...
const o = `https://xgzlyhd.samr.gov.cn`,
    s = new URL(`gjjly/message/getMessageList`, o).href,
    c = new URL(`gjjly/message/getDataList`, o).href,
    l = new URL(`gjjly/index`, o).href,
    u = { category: `1`, department: `2` },
    d = async (e) => {
        let { data: n } = await t.post(c, { json: { type: u[e] } });
        return n.data;
    },
    f = async (e, t) => {
        let n = (await d(e)).filter((e) => e.name === t || e.code === t);
    ...
    p = {
        ...
        radar: [{ source: [`xgzlyhd.samr.gov.cn/gjjly/index`] }],
        name: `留言咨询`,
        maintainers: [`nczitzk`],
        handler: m,
...
async function m(c) {
    let { category: u, department: d } = c.req.param(),
        p = c.req.query(`limit`) ? Number.parseInt(c.req.query(`limit`), 10) : 10,
        m,
        h;
    (u && (m = await f(`category`, u)), d && (h = await f(`department`, d)));
    let { data: g } = await t.post(s, { json: { clyj: ``, curPage: `1`, endTime: ``, fzsj: h?.code ?? ``, lybt: void 0, lylx: m?.code ?? ``, lynr: ``, startTime: ``, zj: `` } }),
        _ = g.data.data
            .slice(0, p)
            .map((t) => ({
                title: t.lybt,
                ...
                description: a(
                    t
                        ? r(`div`, {
                              children: [
                                  r(`span`, { children: [n(`img`, { height: `50px`, src: `https://xgzlyhd.samr.gov.cn/gjjly/img/fd-q-avator.png` }), n(`b`, { children: t.lyr })] }),
                                  r(`div`, { children: [n(`h3`, { children: t.lybt }), r(`p`, { children: [`留言日期：`, t.lysj] }), n(`div`, { style: `word-break: break-all;`, children: t.lynr }), n(`br`, {})] }),
                                  r(`span`, { children: [n(`img`, { height: `50px`, src: `https://xgzlyhd.samr.gov.cn/gjjly/img/fd-a-avator.png` }), n(`b`, { children: t.fzsjCn })] }),
                                  r(`div`, { children: [r(`p`, { children: [`时间：`, t.pubtime] }), n(`div`, { style: `word-break: break-all;`, children: t.clyj })] }),
                              ],
                          })
                        : null
                ),
                author: `${t.lyr} ⇄ ${t.fzsjCn}`,
                category: [t.fzsjCn],
                guid: `${l}#${t.zj}`,
                pubDate: e(t.pubtime),
            })),
        ...
        b = `国家市场监督管理总局`,
        x = y(`title`).text(),
        S = [m ? m.name : void 0, h ? h.name : void 0].filter(Boolean).join(` - `),
        C = new URL(y(`link[rel="icon"]`).prop(`href`), o).href;
    return {
        item: _,
        title: `${b}${x}${S ? ` - ${S}` : ``}`,
        link: l,
        description: y(`meta[property="og:description"]`).prop(`content`),
        language: `zh`,
        image: new URL(`gjjly/${y(`div.fd-logo img`).prop(`src`)}`, o).href,
        icon: C,
        logo: C,
        subtitle: S,
        author: b,
