...
async function a(i) {
    ...
    let l = (await n({ method: `get`, url: `https://${c}api.bitbucket.org/2.0/repositories/${a}/${o}/refs/tags/`, searchParams: r.stringify({ sort: `-target.date` }), headers: s })).data.values;
    return {
        allowEmpty: !0,
        title: `Recent Tags in ${a}/${o}`,
        link: `https://bitbucket.org/${a}/${o}`,
        item: l && l.map((e) => ({ title: e.name, author: e.tagger.raw, description: e.message || `No description`, pubDate: t(e.date), link: e.links.html.href })),
    };
}
export { i as route };
