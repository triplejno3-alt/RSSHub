...
async function s(o) {
    ...
    let s = o.req.param(`tag`),
        ...
        l = (await t.get(`https://api.tumblr.com/v2/tagged`, { searchParams: { tag: s, api_key: a.generateAuthParams(), limit: c }, headers: await a.generateAuthHeaders() })).data.response.map((e) => a.processPost(e));
    return { title: `Tumblr - ${s}`, description: `Tumblr posts tagged #${s}`, link: `https://tumblr.com/tagged/${s}`, item: l, allowEmpty: !0 };
}
export { o as route };
