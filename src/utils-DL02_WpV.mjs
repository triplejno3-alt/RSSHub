...
const s = (e) => {
        let a = e.poster_path ?? e.still_path,
            o = a ? `https://image.tmdb.org/t/p/original${a}` : null,
            s = e.overview.trim();
        return i(r(t, { children: [o ? n(`img`, { src: o }) : null, r(`p`, { children: [`User Score: `, e.vote_average, n(`br`, {}), `Vote Count: `, e.vote_count] }), n(`p`, { children: s })] }));
    },
    c = (t, n) => ({ title: n ? t.title : t.original_title, link: `https://www.themoviedb.org/movie/${t.id}`, description: s(t), pubDate: t.release_date ? e(t.release_date) : void 0 }),
    l = { tv: (t, n) => ({ title: n ? t.name : t.original_name, link: `https://www.themoviedb.org/tv/${t.id}`, description: s(t), pubDate: t.first_air_date ? e(t.first_air_date) : void 0 }), movie: c };
