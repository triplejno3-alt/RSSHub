...
import { n as e, t } from './utils-Bv7EW46S.mjs';
const n = {
...
async function r(n) {
    let r = { 1: `清纯唯美`, 2: `摄影私房`, 4: `明星写真`, 5: `三次元`, 6: `异域美景`, 7: `性感妖姬`, 9: `游戏主题`, 11: `美女壁纸` },
        i = n.req.param(`category`),
        a = `${e}/category-${i}/list-1/index.html?page=1`;
    return await t(n, r[i], a);
}
export { n as route };
