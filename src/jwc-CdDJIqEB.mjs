...
const a = `https://www.qztc.edu.cn/jwc/`,
    o = {
        path: `/jwc/:type`,
        ...
        url: `www.qztc.edu.cn`,
        handler: s,
        radar: [{ source: [`www.qztc.edu.cn/jwc/:type/list.htm`], target: `/jwc/:type` }],
        description: `| 板块 | 参数 |
| ------- | ------- |
| 教务动态 | jwdt |
| 首 页 | 1020 |
...
async function s(o) {
    ...
    return { title: c(`head > title`).text() + ` - 泉州师范学院-教务处`, link: a + s + `/list.htm`, item: u };
}
export { o as route };
