...
import { a as t, n } from './google-Ewtr97IX.mjs';
import { n as r } from './youtubei-Dm3Pz4f6.mjs';
const i = {
...
async function a(e) {
    return await t({ googleApi: n, youtubeiApi: r, params: { playlistId: e.req.param(`id`), embed: !e.req.param(`embed`), isJsonFeed: e.req.query(`format`) === `json` } });
}
export { i as route };
