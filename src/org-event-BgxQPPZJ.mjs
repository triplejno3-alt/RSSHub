...
const i = {
    ...
    features: { requireConfig: [{ name: `GITHUB_ACCESS_TOKEN`, optional: !0, description: `GitHub access token to avoid access limit` }], requirePuppeteer: !1, antiCrawler: !1, supportBT: !1, supportPodcast: !1, supportScihub: !1 },
    radar: [{ source: [`github.com/orgs/:org`], target: `/org_event/:org` }],
    name: `Organization Event`,
    maintainers: [`mslxl`],
    handler: a,
};
async function a(n) {
    let i = n.req.param(`org`),
        a = n.req.param(`types`) || `all`,
        o = e.github && e.github.access_token,
        s = {};
    o && (s.Authorization = `token ${e.github.access_token}`);
    let c = r(a, (await t({ method: `get`, url: `https://api.github.com/orgs/${i}/events`, headers: s, searchParams: { per_page: 100 } })).data);
    return { title: `${i} GitHub organization Feed - ${a === `all` ? `All Events` : `Events: ${a}`}`, link: `https://github.com/${i}`, description: `GitHub events received by ${i}`, item: c };
}
export { i as route };
