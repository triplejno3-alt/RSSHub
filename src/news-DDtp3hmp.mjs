...
async function a() {
    let i = (
        await n({
            method: `get`,
            url: r(`https://api.xiaoheihe.cn/bbs/app/feeds/news?os_type=web&app=heybox&client_type=mobile&version=999.0.3&x_client_type=web&x_os_type=Mac&x_app=heybox&heybox_id=-1&appid=900018355&offset=0&limit=20`),
        })
    ).data.result.links
    ...
    return (
        ...
        { title: `小黑盒游戏新闻`, link: `https://xiaoheihe.cn`, item: i }
    );
}
export { i as route };
