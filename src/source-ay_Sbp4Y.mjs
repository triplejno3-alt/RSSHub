...
fragment UserPost on Post {
  ...
  bookmarked
  downvoted
}`,variables:{source:c,supportedTypes:[`article`,`video:youtube`,`collection`],period:30,first:l,after:``,loggedIn:!1}}),u,!0),t.cache.routeExpire,!1);return{title:`${p.name} posts on daily.dev`,description:p.description,link:d,item:m,image:p.image,logo:p.image,icon:p.image,language:`en-us`}}export{s as route};