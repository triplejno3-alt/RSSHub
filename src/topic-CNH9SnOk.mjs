...
| Updates                  | updates            |
| Video                    | video              |`};async function r(n){let r=`https://grist.org`,i=n.req.param(`topic`),a=(await t(`${r}/wp-json/wp/v2/categories?slug=${i}`))[0].id,o=await e(await t(`${r}/wp-json/wp/v2/posts?categories=${a}&_embed`));return{title:`${i[0].toUpperCase()+i.slice(1)} - Gist Articles`,link:`${r}/${i}`,item:o,description:`${i[0].toUpperCase()+i.slice(1)} Articles on grist.org`,logo:`https://grist.org/wp-content/uploads/2021/03/cropped-Grist-Favicon.png?w=192`,icon:`https://grist.org/wp-content/uploads/2021/03/cropped-Grist-Favicon.png?w=32`,language:`en-us`}}export{n as route};