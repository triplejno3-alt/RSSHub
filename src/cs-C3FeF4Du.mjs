import"./ofetch-uhy-qh6X.mjs";import"./config-Cc-zZ5p-.mjs";import"./logger-_vmdpChp.mjs";import{t as e}from"./cache-DLkCV5c7.mjs";import"./helpers-C9wXLK0V.mjs";import{t}from"./parse-date-DjdQS_Nt.mjs";import{t as n}from"./got-CKQ7C9HX.mjs";import{t as r}from"./timezone-CrV-DT8S.mjs";import{load as i}from"cheerio";import a from"iconv-lite";const o=e=>{let t=/charset="?'?gb/i.test(e.toString())?`gbk`:`utf-8`;return a.decode(e,t)},s={path:`/:category{.+}?`,name:`栏目`,parameters:{category:`分类，见下表，默认为首页`},maintainers:[`nczitzk`],description:`| 要闻 | 公司 | 市场 | 基金 |
| ---- | ---- | ---- | ---- |
| xwzx | ssgs | gppd | tzjj |
