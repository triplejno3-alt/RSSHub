        ...
        item: await Promise.all(
            o.items.map((n) =>
                t.tryGet(n.link, async () => {
                    let t = i(await e(n.link))(`#main-content`);
                    return (
                        t.find(`.article-body__footer`).remove(),
                        t.find(`[class*="ContentHeaderContributorImage"]`).remove(),
                        t.find(`h1`).remove(),
                        { title: n.title, pubDate: n.pubDate, link: n.link, category: n.categories, description: t.html() }
                    );
                })
            )
        ),
