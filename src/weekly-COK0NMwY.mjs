...
const t = (e) => {
        let { id: t } = e.req.param(),
            n = Number.parseInt(e.req.query(`limit`) ?? `20`, 10);
        e.set(`redirect`, `/iresearch/report/3${t ? `/${t}` : ``}?limit=${n}`);
    },
    n = {
        path: `/weekly/:id?`,
        name: `周度市场观察`,
        ...
        radar: [
            {
                ...
                target: (e, t) => {
                    ...
                    return `/iresearch/weekly${r ? `/${r}` : ``}`;
                },
            },
            { title: `家电行业`, source: [`www.iresearch.com.cn/report.shtml`], target: `/weekly/1` },
            { title: `服装行业`, source: [`www.iresearch.com.cn/report.shtml`], target: `/weekly/2` },
            { title: `美妆行业`, source: [`www.iresearch.com.cn/report.shtml`], target: `/weekly/3` },
            { title: `食品饮料行业`, source: [`www.iresearch.com.cn/report.shtml`], target: `/weekly/4` },
            { title: `酒行业`, source: [`www.iresearch.com.cn/report.shtml`], target: `/weekly/5` },
        ],
        view: e.Articles,
    };
