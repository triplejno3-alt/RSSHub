...
const r = {
    ...
    radar: [{ source: [`ikea.cn/cn/zh/campaigns/wo3-men2-de-chao1-zhi2-di1-jia4-pub8b08af40`, `ikea.cn/`] }],
    name: `中国 - 低价优选`,
    ...
    return {
        ...
        item: (
            await e({
                ...
                headers: t(),
                searchParams: { processOutOfStock: `SORT`, groupId: `cms_product_cn--zh--8b08af400ac511ec909ec36c6e99b004_0_0`, page: 1, size: 200 },
            })
        ).data.products.map((e) => n(e)),
    };
}
export { r as route };
