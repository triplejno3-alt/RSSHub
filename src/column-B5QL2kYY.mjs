...
| ---------- | --------------- |
| 31         | 13              |
</details>`};async function s(o){let{data:s,url:c}=await t(`${i}/column/${o.req.param(`columnId`)}`),l=a(s),u=r(l),d=await Promise.all(u.map(t=>e.tryGet(t.link,()=>n(t))));return{title:l(`head title`).text(),link:c,item:d}}export{o as route};