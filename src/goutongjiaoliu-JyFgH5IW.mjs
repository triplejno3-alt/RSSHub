...
const a = {
    ...
    radar: [{ source: [`pbc.gov.cn/goutongjiaoliu/113456/113469/index.html`] }],
    name: `沟通交流`,
    maintainers: [`nczitzk`],
    handler: o,
...
async function o() {
    let a = `http://www.pbc.gov.cn/goutongjiaoliu/113456/113469/index.html`,
        o = await r(),
        s = await o.newPage();
        ...
        u = await Promise.all(
            l.map((r) =>
                e.tryGet(r.link, async () => {
                    ...
                    return ((r.description = a(`#zoom`).html()), (r.pubDate = n(t(a(`.hui12`).eq(5).text()), 8)), r);
                })
            )
        );
    return (await o.close(), { title: `中国人民银行 - 沟通交流`, link: a, item: u });
}
export { a as route };
