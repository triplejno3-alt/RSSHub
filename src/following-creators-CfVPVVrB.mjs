...
const r = {
    ...
    handler: i,
    radar: [{ title: `Following Creators`, source: [`skeb.jp/:username`], target: `/following_creators/:username` }],
...
async function i(r) {
    ...
    let a = await n(i, `following_creators`);
    return { title: `Skeb - ${i} - フォロー中のクリエイター`, link: `https://skeb.jp/${i}`, item: a };
}
export { r as route };
