...
const u = ({ images: e, intro: t, description: n }) =>
        c(o(i, { children: [e?.map((e) => (e?.src ? a(`figure`, { children: a(`img`, { src: e.src, alt: e.alt }) }) : null)), t ? a(`blockquote`, { children: t }) : null, n ? l(n) : null] })),
    d = async (r) => {
        let { lang: i = `en` } = r.req.param(),
            a = Number.parseInt(r.req.query(`limit`) ?? `30`, 10),
            o = `https://www.deepl.com`,
            c = new URL(`${i}/blog`, o).href,
            l = s(await e(c)),
            d = l(`html`).attr(`lang`) ?? i,
            f = [];
        return (
            (f = l(`h4, h6`)
                .slice(0, a)
                .toArray()
                .map((e) => {
                    let t = l(e).parent().parent(),
                        r = t.find(`h4, h6`).text(),
                        i = t.find(`img`).attr(`src`),
                        a = u({ images: i ? [{ src: i, alt: r }] : void 0, intro: t.find(`p`).text() }),
                        s = t.find(`time`).attr(`datetime`),
                        c = t.attr(`href`),
                        f = t
                            .find(`span.me-6 span`)
                            .last()
                        ...
                        p = s;
                    return { title: r, description: a, pubDate: s ? n(s) : void 0, link: c ? new URL(c, o).href : void 0, author: f, content: { html: a, text: a }, image: i, banner: i, updated: p ? n(p) : void 0, language: d };
                })),
            (f = await Promise.all(
                f.map((r) =>
                    r.link
                        ? t.tryGet(r.link, async () => {
                              let t = s(await e(r.link)),
                                  i = t(`h1[data-contentful-field-id="title"]`).text(),
                                  a = r.description + u({ description: t(`div.my-redesign-3`).html() }),
                                  o = t(`time`).first().attr(`datetime`),
                                  c = t(`span[data-contentful-field-id="author"] span`)
                                      .last()
                                      .text()
                                      .split(/,\s/)
                                      .map((e) => ({ name: e, url: void 0, avatar: void 0 })),
                                  l = t(`meta[property="og:image"]`).attr(`content`) ?? t(`picture[data-contentful-field-id="image"] img`).attr(`src`),
                                  f = o,
                                  p = { title: i, description: a, pubDate: o ? n(o) : r.pubDate, author: c, content: { html: a, text: a }, image: l, banner: l, updated: f ? n(f) : r.updated, language: d };
                              return { ...r, ...p };
                          })
                        : r
                )
    ...
    p = {
        ...
        parameters: { lang: { description: 'Language, `en` as English by default', options: f } },
        description: `::: tip
        ...
        radar: [
            {
                ...
                target: (e) => {
                    let t = e.lang;
                    return `/deepl/blog${t ? `/${t}` : ``}`;
                },
            },
            { title: `Deutsch`, source: [`www.deepl.com/de/blog`], target: `/blog/de` },
            { title: `English`, source: [`www.deepl.com/en/blog`], target: `/blog/en` },
            { title: `Español`, source: [`www.deepl.com/es/blog`], target: `/blog/es` },
            { title: `日本語`, source: [`www.deepl.com/ja/blog`], target: `/blog/ja` },
            { title: `Français`, source: [`www.deepl.com/fr/blog`], target: `/blog/fr` },
            { title: `Italiano`, source: [`www.deepl.com/it/blog`], target: `/blog/it` },
            { title: `Bahasa Indonesia`, source: [`www.deepl.com/id/blog`], target: `/blog/id` },
            { title: `한국어`, source: [`www.deepl.com/ko/blog`], target: `/blog/ko` },
            { title: `Nederlands`, source: [`www.deepl.com/nl/blog`], target: `/blog/nl` },
            { title: `Čeština`, source: [`www.deepl.com/cs/blog`], target: `/blog/cs` },
            { title: `Svenska`, source: [`www.deepl.com/sv/blog`], target: `/blog/sv` },
            { title: `Polski`, source: [`www.deepl.com/pl/blog`], target: `/blog/pl` },
            { title: `Português (Brasil)`, source: [`www.deepl.com/pt-BR/blog`], target: `/blog/pt-BR` },
            { title: `Português`, source: [`www.deepl.com/pt-PT/blog`], target: `/blog/pt-PT` },
            { title: `Türkçe`, source: [`www.deepl.com/tr/blog`], target: `/blog/tr` },
            { title: `Русский`, source: [`www.deepl.com/ru/blog`], target: `/blog/ru` },
            { title: `简体中文`, source: [`www.deepl.com/zh/blog`], target: `/blog/zh` },
            { title: `Українська`, source: [`www.deepl.com/uk/blog`], target: `/blog/uk` },
            { title: `العربية`, source: [`www.deepl.com/ar/blog`], target: `/blog/ar` },
        ],
        view: r.Articles,
        zh: {
            path: `/blog/:lang?`,
            ...
            handler: d,
            example: `/deepl/blog/en`,
            parameters: { lang: { description: '语言，默认为 `en`，可在对应语言页 URL 中找到', options: f } },
            description: `::: tip
