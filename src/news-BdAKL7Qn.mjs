...
const i = {
    ...
    radar: [{ source: [`gs.ustb.edu.cn/:type`] }],
    name: `研究生院`,
    maintainers: [`DA1Y1`],
    handler: a,
...
async function a(i) {
    let a = i.req.param(`type`),
        o = {
            all: {
                selector: { list: `.plist li` },
                timeSelector: { list: `.datatime` },
                titleSelector: { list: `.adaptitle` },
                linkSelector: { list: `li a` },
            ...
            cres: {
                selector: { list: `.centerright_center li` },
                timeSelector: { list: `.fright` },
                titleSelector: { list: `.fleft` },
                linkSelector: { list: `li a` },
            ...
            seee: {
                selector: { list: `.list_left2 li` },
                timeSelector: { list: `li span` },
                titleSelector: { list: `li a` },
                linkSelector: { list: `li a` },
            ...
            metall: {
                selector: { list: `#news-list-title li` },
                timeSelector: { list: `.date-size` },
                titleSelector: { list: `.info-size` },
                linkSelector: { list: `li a` },
            ...
            saee: {
                selector: { list: `.sidebar_b a:gt(1):lt(15)` },
                timeSelector: { list: `.list_time` },
                titleSelector: { list: `.list_timu` },
                linkSelector: { list: `a` },
            ...
            scce: {
                selector: { list: `.lead li` },
                timeSelector: { list: `.practice_list_right` },
                titleSelector: { list: `.practice_list_left` },
                linkSelector: { list: `li a` },
            ...
            shuli: {
                selector: { list: `.jy-lb li` },
                timeSelector: { list: `li span` },
                titleSelector: { list: `li p` },
                linkSelector: { list: `li a` },
            ...
            sem: {
                selector: { list: `.sub_002 li` },
                timeSelector: { list: `.time` },
            ...
            wenfa: {
                selector: { list: `.list-content-box .specialDate_fontBox` },
                timeSelector: { list: `.specialTime` },
                titleSelector: { list: `.specialTime_a` },
                linkSelector: { list: `div a` },
            ...
            marx: {
                selector: { list: `.list_l li` },
                timeSelector: { list: `.time2` },
                titleSelector: { list: `.list_title` },
                linkSelector: { list: `li a` },
            ...
            sfs: {
                selector: { list: `.list-unstyled li` },
                timeSelector: { list: `` },
                titleSelector: { list: `.text-overflow` },
                linkSelector: { list: `li a` },
            ...
            skl: {
                selector: { list: `.cultureStudent_top li` },
                timeSelector: { list: `li span` },
                titleSelector: { list: `li p` },
                linkSelector: { list: `li a` },
            ...
            iet: {
                selector: { list: `table tr td table tr td .liststyle:lt(20)` },
                timeSelector: { list: `.notestyle` },
                titleSelector: { list: `td a` },
                linkSelector: { list: `td a` },
        ...
        s = o[a].url,
        c = await t({ method: `get`, responseType: `buffer`, url: s }),
        l = n(a === `iet` ? r.decode(c.data, `gb2312`) : c.data),
        u = l(o[a].selector.list);
    return {
        title: o[a].name,
        link: o[a].link,
        ...
        item: u.toArray().map((t) => {
            t = l(t);
            let n = t.find(l(o[a].timeSelector.list)).text(),
                r;
            n !== `` && (n.includes(`[`) && (n = n.slice(1, 11)), (r = e(n)));
            let i = t.find(l(o[a].linkSelector.list)).attr(`href`);
            i === void 0 && (i = t.attr(`href`));
            let s = t.find(l(o[a].titleSelector.list)).clone().children().remove().end().text();
            return (s === `` && (s = t.find(l(o[a].titleSelector.list)).text()), r === void 0 ? { title: s, description: s, link: i } : { title: s, description: s, link: i, pubDate: r });
        }),
    };
}
export { i as route };
