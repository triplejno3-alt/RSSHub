...
const n = {
    ...
    radar: [{ source: [`grist.org/series/:series`] }],
    name: `Series`,
...
async function r(n) {
    let r = `https://grist.org`,
        i = n.req.param(`series`),
        a = (await t(`${r}/wp-json/wp/v2/series?slug=${i}`))[0].id,
        o = await e(await t(`${r}/wp-json/wp/v2/posts?series=${a}&_embed`));
    return {
