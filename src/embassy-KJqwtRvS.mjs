...
var i = {
    ...
    fr: {
        ...
        consulates: {
            marseille: { cityCN: `马赛`, link: `http://marseille.china-consulate.org/chn/lsfwgg/`, list: `.newslist a`, title: `#News_Body_Title`, description: `#News_Body_Txt_A`, pubDate: `#News_Body_Time` },
            strasbourg: {
                cityCN: `斯特拉斯堡`,
    ...
    jp: {
        ...
        pubDate: `#article > tbody > tr:nth-child(1) > td > table > tbody > tr:nth-child(4) > td`,
        consulates: {
            nagasaki: { cityCN: `长崎`, link: `http://nagasaki.china-consulate.org/chn/tzgg/`, list: `.newsList a`, title: `#News_Body_Title`, description: `#News_Body_Txt_A`, pubDate: `#News_Body_Time` },
            osaka: {
                cityCN: `大阪`,
    ...
    my: { country: `my`, countryCN: `马来西亚`, link: `http://my.china-embassy.org/chn/zytz/`, list: `div[class=nbox_ul] > ul a`, title: `#News_Body_Title`, description: `#News_Body_Txt_A`, pubDate: `#News_Body_Time` },
    sg: { country: `sg`, countryCN: `新加坡`, link: `http://sg.china-embassy.gov.cn/lsfw_0/zytz/`, list: `div.news-list a[target=_blank]`, title: `#News_Body_Title`, description: `div.trs_editor_view`, pubDate: `div.view-date` },
    uk: {
        country: `uk`,
        countryCN: `英国`,
        ...
        consulates: {
            belfast: { cityCN: `贝尔法斯特`, link: `http://belfast.chineseconsulate.org/chn/tztg/`, list: `div.newslist a`, title: `#News_Body_Title`, description: `#News_Body_Txt_A > div`, pubDate: `#News_Body_Time` },
            edinburgh: {
                cityCN: `爱丁堡`,
    ...
    us: {
        ...
        consulates: {
            ...
            newyork: { cityCN: `纽约`, link: `http://newyork.china-consulate.org/chn/fwzc/zxtz/`, list: `div.cbox_ul a`, title: `#News_Body_Title`, description: `#News_Body_Txt_A`, pubDate: `#News_Body_Time` },
            sanfrancisco: { cityCN: `旧金山`, link: `http://www.chinaconsulatesf.org/chn/zytz/`, list: `div#docMore a`, title: `#News_Body_Title`, description: `#article > .News_Body_Txt_A`, pubDate: `#News_Body_Time` },
        },
    },
};
const a = { path: `/:country/:city?`, name: `Unknown`, maintainers: [`HenryQW`], handler: o };
async function o(a) {
    let o = a.req.param(`country`),
        s = a.req.param(`city`) ?? void 0,
        c = i[o.toLowerCase()],
        l;
    s === void 0 ? (l = `中国驻${c.countryCN}大使馆 -- 重要通知`) : ((c = c.consulates[s.toLowerCase()]), (l = `中国驻${c.cityCN}领事馆 -- 重要通知`));
    let u = c.link,
    ...
    f(c.list)
        .slice(0, 10)
        .each((e, t) => {
            let n = new URL(f(t).attr(`href`), u);
            n.hostname === d && p.push(n);
        });
    let m = await Promise.all(
        p.map((i) =>
            e.tryGet(i.href, async () => {
                let e = r((await n(i)).data);
                return { title: e(c.title).text(), link: i, description: e(c.description).html(), pubDate: t(e(c.pubDate).text().replace(`(`, ``).replace(`)`, ``)) };
            })
        )
    );
    return { title: l, description: l, link: u, item: m };
}
export { a as route };
