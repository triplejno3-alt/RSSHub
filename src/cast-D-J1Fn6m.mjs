...
import { i as n, n as r, r as i, t as a } from './utils-nGmSsbvy.mjs';
const o = {
    path: `/user/:id/cast`,
    ...
    radar: [{ source: [`otobanana.com/user/:id/cast`, `otobanana.com/user/:id`] }],
    name: `Cast 音声投稿`,
    maintainers: [`TonyRL`],
    handler: s,
};
async function s(o) {
    let s = o.req.param(`id`),
        ...
        { data: l } = await t(`${a}/users/${s}/casts/`),
        u = l.results.map((e) => n(e));
    return (
        o.set(`json`, { userInfo: c, castData: l }),
        {
            title: `${c.name} (@${c.username}) - 音声投稿 | OTOBANANA`,
