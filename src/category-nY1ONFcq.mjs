    ...
    return {
        ...
        item: (
            await t.tryGet(
                'jin10:aa:${category}',
                async () => {
                    let { data: e } = await r(`https://4a735ea38f8146198dc205d2e2d1bd28.z3c.jin10.com/flash`, {
                        headers: { 'x-app-id': `bVBF4FyRTn5NJF5n`, 'x-version': `1.0` },
                        searchParams: { channel: `-8200`, vip: `1`, classify: `[${s}]` },
                    });
            ...
            let t = e.data.content.match(/^【(.*?)】/),
                r,
                a = e.data.content;
            return (t ? ((r = t[1]), (a = a.replace(t[0], ``))) : (r = e.data.vip_title || e.data.content), { title: r, description: o(a, e.data.pic), pubDate: i(n(e.time), 8), guid: `jin10:category:${e.id}` });
        }),
    };
}
export { s as route };
