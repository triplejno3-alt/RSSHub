...
const i = async (i) => {
        let { id: a, tab: o } = i.req.param(),
            ...
            c = new URL(`categories/${a}${o ? `?tab=${o}` : ``}`, n).href,
            l = new URL(`gapi/v1/categories/${a}/${o ?? `originals`}`, n).href,
    ...
    a = {
        ...
        radar: [
            ...
            { title: `全部`, source: [`www.gcores.com/categories/:id`], target: `/gcores/categories/:id` },
            { title: `播客`, source: [`www.gcores.com/categories/:id`], target: `/categories/:id/radios` },
            { title: `文章`, source: [`www.gcores.com/categories/:id`], target: `/categories/:id/articles` },
            { title: `资讯`, source: [`www.gcores.com/categories/:id`], target: `/categories/:id/news` },
            { title: `视频`, source: [`www.gcores.com/categories/:id`], target: `/categories/:id/videos` },
        ],
        view: r,
    };
