...
const i = `https://www.tokeninsight.com/`,
    a = {
        ...
        radar: [{ source: [`tokeninsight.com/:lang/blogs`], target: `/blog/:lang` }],
        name: `Blogs`,
...
async function o(a) {
    let o = a.req.param(`lang`) ?? `zh`,
        s = async () => {
            ...
            return (await n.post(e, { form: { isRecommend: 2, language: o === `zh` ? `cn` : o } })).data.data.blogsList;
        },
        c = async (a) => {
    ...
    return { title: `${o === `zh` ? `博客` : `Blogs`} | TokenInsight`, link: `https://www.tokeninsight.com/${o}/blogs`, item: d };
}
export { a as route };
