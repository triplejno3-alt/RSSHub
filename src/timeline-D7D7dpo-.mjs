...
import { n, o as r, r as i, t as a } from './utils-nGmSsbvy.mjs';
const o = {
    path: `/user/:id`,
    ...
    radar: [{ source: [`otobanana.com/user/:id`] }],
...
async function s(o) {
    let s = o.req.param(`id`),
        ...
        { data: l } = await t(`${a}/users/${s}/posts/`),
        u = l.results.map((e) => r(e));
    return (
        o.set(`json`, { userInfo: c, postData: l }),
        {
            title: `${c.name} (@${c.username}) - タイムライン | OTOBANANA`,
