...
import { a as r, i, o as a, t as o } from './utils-ZvzRBK0Y.mjs';
...
const c = {
    ...
    parameters: { handle: `User handle, can be found in URL`, routeParams: `Filter parameter, Use filter to customize content types` },
    features: { requireConfig: !1, requirePuppeteer: !1, antiCrawler: !1, supportBT: !1, supportPodcast: !1, supportScihub: !1 },
    radar: [{ source: [`bsky.app/profile/:handle`] }],
    name: `Post`,
    maintainers: [`TonyRL`],
    handler: l,
    description: `
...
async function l(n) {
    let c = n.req.param(`handle`),
        l = s.parse(n.req.param(`routeParams`)).filter || `posts_and_author_threads`,
        u = await r(c, e.tryGet),
        d = await i(u, e.tryGet),
        f = await o(u, l, e.tryGet),
        p = f.feed.map(({ post: e }) => ({
...
`,
    ...
    return (
        n.set(`json`, { DID: u, profile: d, authorFeed: f }),
        {
            title: `${d.displayName} (@${d.handle}) — Bluesky`,
            description: d.description?.replaceAll(
                `
`,
                ` `
            ),
            link: `https://bsky.app/profile/${d.handle}`,
            image: d.avatar,
            icon: d.avatar,
            logo: d.avatar,
            item: p,
