...
const i = async (i) => {
        let { category: a = `news-325` } = i.req.param(),
            o = i.req.query(`limit`) ? Number.parseInt(i.req.query(`limit`), 10) : 12,
            s = `https://www.cngold.org.cn`,
            c = new URL(`${a}.html`, s).href,
            { data: l } = await n(c),
            u = r(l),
            d = u(`html`).prop(`lang`),
            f = u(`ul.newsList li`)
                .slice(0, o)
                .toArray()
                .map((e) => ((e = u(e)), { title: e.find(`t1`).text(), pubDate: t(e.find(`div.min, div.day`).text(), [`YYYY-MM-DD`, `MM-DD`]), link: new URL(e.find(`a`).prop(`href`), s).href, language: d }));
        f = await Promise.all(
            f.map((i) =>
                e.tryGet(i.link, async () => {
                    let { data: e } = await n(i.link),
                        a = r(e),
                        o = a(`div.details_top div.t1`).text(),
                        s = a(`div.details_con`).html();
                    return (
                        (i.title = o),
                        (i.description = s),
                        (i.pubDate = t(a(`div.details_top div.min span`).first().text())),
                        (i.author = a(`div.details_top div.min span`).last().text().split(/：/).pop()),
                        (i.content = { html: s, text: a(`div.details_con`).text() }),
                        (i.language = d),
                        i
                    );
                })
        ...
        let p = new URL(u(`div.logo img`).prop(`src`), s).href;
        return {
            title: `${u(`title`).text()} - ${u(`div.tab a.current`).text()}`,
            description: u(`meta[name="description"]`).prop(`content`),
            link: c,
            item: f,
            allowEmpty: !0,
            image: p,
            author: u(`meta[name="keywords"]`).prop(`content`),
            language: d,
        };
    },
    a = {
...
| [technology-318](https://rsshub.app/cngold/technology-318)          | [technology-319](https://rsshub.app/cngold/technology-319)    | [technology-320](https://rsshub.app/cngold/technology-320)  | [technology-350](https://rsshub.app/cngold/technology-350)    |
    ...
    `,
        ...
        radar: [
            ...
            { title: `政策法规 - 法律法规`, source: [`www.cngold.org.cn/policies-245.html`], target: `/policies-245` },
            { title: `政策法规 - 产业政策`, source: [`www.cngold.org.cn/policies-262.html`], target: `/policies-262` },
            { title: `政策法规 - 黄金标准`, source: [`www.cngold.org.cn/policies-281.html`], target: `/policies-281` },
            { title: `行业培训 - 黄金投资分析师`, source: [`www.cngold.org.cn/training-242.html`], target: `/training-242` },
            { title: `行业培训 - 教育部1+X`, source: [`www.cngold.org.cn/training-246.html`], target: `/training-246` },
            { title: `行业培训 - 矿业权评估师`, source: [`www.cngold.org.cn/training-338.html`], target: `/training-338` },
            { title: `行业培训 - 其他培训`, source: [`www.cngold.org.cn/training-247.html`], target: `/training-247` },
            { title: `黄金科技 - 黄金协会科学技术奖`, source: [`www.cngold.org.cn/technology-318.html`], target: `/technology-318` },
            { title: `黄金科技 - 科学成果评价`, source: [`www.cngold.org.cn/technology-319.html`], target: `/technology-319` },
            { title: `黄金科技 - 新技术推广`, source: [`www.cngold.org.cn/technology-320.html`], target: `/technology-320` },
            { title: `黄金科技 - 黄金技术大会`, source: [`www.cngold.org.cn/technology-350.html`], target: `/technology-350` },
        ],
    };
