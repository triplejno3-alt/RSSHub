...
const u = ({ images: e, description: t }) =>
    ...
    d = async (r) => {
        let { category: i } = r.req.param(),
            a = Number.parseInt(r.req.query(`limit`) ?? `20`, 10),
            o = `http://banshujiang.cn`,
            c = new URL(`${i ? `e_books` : `category/${i}`}/page/1`, o).href,
            l = s(await e(c)),
            d = l(`html`).attr(`lang`) ?? `zh`,
            f = [];
        ((f = l(`ul.small-list li.row`)
            .slice(0, a)
            .toArray()
            .map((e) => {
                let t = l(e),
                    r = t.find(`span.book-property__title`).first().next(`a`),
                    i = r.text().trim(),
                    a = t.find(`meta[property="og:image"]`).attr(`content`) ?? t.find(`img`).attr(`src`),
                    s = u({ images: a ? [{ src: a, alt: i }] : void 0, description: t.find(`div.small-list__item-desc`).html() }),
                    c = a?.split(/\?timestamp=/).pop(),
                    f = r.attr(`href`),
                    p = t.find(`span.book-property__title`).toArray(),
                    m = [...new Set(p.map((e) => l(e).next(`span`).text()).filter(Boolean))],
                    h = t.find(`span.book-property__title`).eq(1).text(),
                    g = c;
                return {
                    title: i,
                    description: s,
                    pubDate: c ? n(c, `x`) : void 0,
                    ...
                    r.link
                        ? t.tryGet(r.link, async () => {
                              let t = s(await e(r.link)),
                                  i = t(`div.ebook-title`).text().trim(),
                                  a = t(`div.span6 img`).attr(`src`),
                                  c = u({ images: a ? [{ src: a, alt: i }] : void 0, description: (t(`table`).first().parent().html() ?? ``) + (t(`div.ebook-markdown`).html() ?? ``) });
                              t(`ul.inline`).parent().parent().remove();
                              let l = a?.split(/\?timestamp=/).pop(),
                                  f = t(`div.ebook-title a`).attr(`href`),
                                  p = [
                                      ...new Set(
                                          t(`table tr`)
                                              .toArray()
                                              .map((e) => t(e).find(`td`).last().text())
                                              .filter(Boolean)
                                      ),
                                  ],
                                  m = t(`table tr`).first().find(`td`).last().text(),
                                  h = l,
                                  g = {
                                      title: i,
                                      description: c,
                                      pubDate: l ? n(l, `x`) : r.pubDate,
                                      link: f ? new URL(f, o).href : r.link,
                                      category: p,
                                      author: m,
                                      content: { html: c, text: c },
                                      image: a,
                                      banner: a,
                                      updated: h ? n(h, `x`) : r.updated,
                                      language: d,
                                  };
                              return { ...r, ...g };
                          })
        ...
        return {
            title: p,
            description: p.split(/-/).pop()?.trim(),
            link: c,
            item: f,
            allowEmpty: !0,
            image: new URL(`logo.png?imageView2/2/w/128/h/128/q/100`, o).href,
            author: l(`a.brand`).text(),
            language: d,
    ...
    f = {
        ...
        parameters: {
            category: {
                ...
                options: [
                    { label: `ActionScript`, value: `programming_language/ActionScript` },
                    { label: `ASP.net`, value: `programming_language/ASP.net` },
                    { label: `C`, value: `programming_language/C` },
                    { label: `C#`, value: `programming_language/C%23` },
                    { label: `C++`, value: `programming_language/C++` },
                    { label: `CoffeeScript`, value: `programming_language/CoffeeScript` },
                    { label: `CSS`, value: `programming_language/CSS` },
                    { label: `Dart`, value: `programming_language/Dart` },
                    { label: `Elixir`, value: `programming_language/Elixir` },
                    { label: `Erlang`, value: `programming_language/Erlang` },
                    { label: `F#`, value: `programming_language/F%23` },
                    { label: `Go`, value: `programming_language/Go` },
                    { label: `Groovy`, value: `programming_language/Groovy` },
                    { label: `Haskell`, value: `programming_language/Haskell` },
                    { label: `HTML5`, value: `programming_language/HTML5` },
                    { label: `Java`, value: `programming_language/Java` },
                    { label: `JavaScript`, value: `programming_language/JavaScript` },
                    { label: `Kotlin`, value: `programming_language/Kotlin` },
                    { label: `Lua`, value: `programming_language/Lua` },
                    { label: `Objective-C`, value: `programming_language/Objective-C` },
                    { label: `Perl`, value: `programming_language/Perl` },
                    { label: `PHP`, value: `programming_language/PHP` },
                    { label: `PowerShell`, value: `programming_language/PowerShell` },
                    { label: `Python`, value: `programming_language/Python` },
                    { label: `R`, value: `programming_language/R` },
                    { label: `Ruby`, value: `programming_language/Ruby` },
                    { label: `Rust`, value: `programming_language/Rust` },
                    { label: `Scala`, value: `programming_language/Scala` },
                    { label: `Shell Script`, value: `programming_language/Shell%20Script` },
                    { label: `SQL`, value: `programming_language/SQL` },
                    { label: `Swift`, value: `programming_language/Swift` },
                    { label: `TypeScript`, value: `programming_language/TypeScript` },
                    { label: `Android`, value: `mobile_development/Android` },
                    { label: `iOS`, value: `mobile_development/iOS` },
                    { label: `Linux`, value: `operation_system/Linux` },
                    { label: `Mac OS X`, value: `operation_system/Mac%20OS%20X` },
                    { label: `Unix`, value: `operation_system/Unix` },
                    { label: `Windows`, value: `operation_system/Windows` },
                    { label: `DB2`, value: `database/DB2` },
                    { label: `MongoDB`, value: `database/MongoDB` },
                    { label: `MySQL`, value: `database/MySQL` },
                    { label: `Oracle`, value: `database/Oracle` },
                    { label: `PostgreSQL`, value: `database/PostgreSQL` },
                    { label: `SQL Server`, value: `database/SQL%20Server` },
                    { label: `SQLite`, value: `database/SQLite` },
                    { label: `Apache 项目`, value: `open_source/Apache项目` },
                    { label: `Web 开发`, value: `open_source/Web开发` },
                    { label: `区块链`, value: `open_source/区块链` },
                    { label: `程序开发`, value: `open_source/程序开发` },
                    { label: `人工智能`, value: `other/人工智能` },
                    { label: `容器技术`, value: `other/容器技术` },
                    { label: `中文`, value: `language/中文` },
                    { label: `英文`, value: `language/英文` },
                ],
            },
        },
        description: `::: tip
        ...
        radar: [
            {
                ...
                target: (e) => {
                    let t = e.category;
                    return `/banshujiang${t ? `/${t}` : ``}`;
                },
            },
            { title: `ActionScript`, source: [`banshujiang.cn/programming_language/ActionScript/page/1`], target: `/programming_language/ActionScript` },
            { title: `ASP.net`, source: [`banshujiang.cn/programming_language/ASP.net/page/1`], target: `/programming_language/ASP.net` },
            { title: `C`, source: [`banshujiang.cn/programming_language/C`], target: `/programming_language/C` },
            { title: `C#`, source: [`banshujiang.cn/programming_language/C%23`], target: `/programming_language/C%23` },
            { title: `C++`, source: [`banshujiang.cn/programming_language/C++`], target: `/programming_language/C++` },
            { title: `CoffeeScript`, source: [`banshujiang.cn/programming_language/CoffeeScript`], target: `/programming_language/CoffeeScript` },
            { title: `CSS`, source: [`banshujiang.cn/programming_language/CSS`], target: `/programming_language/CSS` },
            { title: `Dart`, source: [`banshujiang.cn/programming_language/Dart`], target: `/programming_language/Dart` },
            { title: `Elixir`, source: [`banshujiang.cn/programming_language/Elixir`], target: `/programming_language/Elixir` },
            { title: `Erlang`, source: [`banshujiang.cn/programming_language/Erlang`], target: `/programming_language/Erlang` },
            { title: `F#`, source: [`banshujiang.cn/programming_language/F%23`], target: `/programming_language/F%23` },
            { title: `Go`, source: [`banshujiang.cn/programming_language/Go`], target: `/programming_language/Go` },
            { title: `Groovy`, source: [`banshujiang.cn/programming_language/Groovy`], target: `/programming_language/Groovy` },
            { title: `Haskell`, source: [`banshujiang.cn/programming_language/Haskell`], target: `/programming_language/Haskell` },
            { title: `HTML5`, source: [`banshujiang.cn/programming_language/HTML5`], target: `/programming_language/HTML5` },
            { title: `Java`, source: [`banshujiang.cn/programming_language/Java`], target: `/programming_language/Java` },
            { title: `JavaScript`, source: [`banshujiang.cn/programming_language/JavaScript`], target: `/programming_language/JavaScript` },
            { title: `Kotlin`, source: [`banshujiang.cn/programming_language/Kotlin`], target: `/programming_language/Kotlin` },
            { title: `Lua`, source: [`banshujiang.cn/programming_language/Lua`], target: `/programming_language/Lua` },
            { title: `Objective-C`, source: [`banshujiang.cn/programming_language/Objective-C`], target: `/programming_language/Objective-C` },
            { title: `Perl`, source: [`banshujiang.cn/programming_language/Perl`], target: `/programming_language/Perl` },
            { title: `PHP`, source: [`banshujiang.cn/programming_language/PHP`], target: `/programming_language/PHP` },
            { title: `PowerShell`, source: [`banshujiang.cn/programming_language/PowerShell`], target: `/programming_language/PowerShell` },
            { title: `Python`, source: [`banshujiang.cn/programming_language/Python`], target: `/programming_language/Python` },
            { title: `R`, source: [`banshujiang.cn/programming_language/R/page/1`], target: `/programming_language/R` },
            { title: `Ruby`, source: [`banshujiang.cn/programming_language/Ruby/page/1`], target: `/programming_language/Ruby` },
            { title: `Rust`, source: [`banshujiang.cn/programming_language/Rust/page/1`], target: `/programming_language/Rust` },
            { title: `Scala`, source: [`banshujiang.cn/programming_language/Scala/page/1`], target: `/programming_language/Scala` },
            { title: `Shell Script`, source: [`banshujiang.cn/programming_language/Shell%20Script/page/1`], target: `/programming_language/Shell%20Script` },
            { title: `SQL`, source: [`banshujiang.cn/programming_language/SQL/page/1`], target: `/programming_language/SQL` },
            { title: `Swift`, source: [`banshujiang.cn/programming_language/Swift/page/1`], target: `/programming_language/Swift` },
            { title: `TypeScript`, source: [`banshujiang.cn/programming_language/TypeScript/page/1`], target: `/programming_language/TypeScript` },
            { title: `Android`, source: [`banshujiang.cn/mobile_development/Android/page/1`], target: `/mobile_development/Android` },
            { title: `iOS`, source: [`banshujiang.cn/mobile_development/iOS/page/1`], target: `/mobile_development/iOS` },
            { title: `Linux`, source: [`banshujiang.cn/operation_system/Linux/page/1`], target: `/operation_system/Linux` },
            { title: `Mac OS X`, source: [`banshujiang.cn/operation_system/Mac%20OS%20X/page/1`], target: `/operation_system/Mac%20OS%20X` },
            { title: `Unix`, source: [`banshujiang.cn/operation_system/Unix/page/1`], target: `/operation_system/Unix` },
            { title: `Windows`, source: [`banshujiang.cn/operation_system/Windows/page/1`], target: `/operation_system/Windows` },
            { title: `DB2`, source: [`banshujiang.cn/database/DB2/page/1`], target: `/database/DB2` },
            { title: `MongoDB`, source: [`banshujiang.cn/database/MongoDB/page/1`], target: `/database/MongoDB` },
            { title: `MySQL`, source: [`banshujiang.cn/database/MySQL/page/1`], target: `/database/MySQL` },
            { title: `Oracle`, source: [`banshujiang.cn/database/Oracle/page/1`], target: `/database/Oracle` },
            { title: `PostgreSQL`, source: [`banshujiang.cn/database/PostgreSQL/page/1`], target: `/database/PostgreSQL` },
            { title: `SQL Server`, source: [`banshujiang.cn/database/SQL%20Server/page/1`], target: `/database/SQL%20Server` },
            { title: `SQLite`, source: [`banshujiang.cn/database/SQLite/page/1`], target: `/database/SQLite` },
            { title: `Apache 项目`, source: [`banshujiang.cn/open_source/Apache项目/page/1`], target: `/open_source/Apache 项目` },
            { title: `Web 开发`, source: [`banshujiang.cn/open_source/Web开发/page/1`], target: `/open_source/Web 开发` },
            { title: `区块链`, source: [`banshujiang.cn/open_source/区块链/page/1`], target: `/open_source/区块链` },
            { title: `程序开发`, source: [`banshujiang.cn/open_source/程序开发/page/1`], target: `/open_source/程序开发` },
            { title: `人工智能`, source: [`banshujiang.cn/other/人工智能/page/1`], target: `/other/人工智能` },
            { title: `容器技术`, source: [`banshujiang.cn/other/容器技术/page/1`], target: `/other/容器技术` },
            { title: `中文`, source: [`banshujiang.cn/language/中文/page/1`], target: `/language/中文` },
            { title: `英文`, source: [`banshujiang.cn/language/英文/page/1`], target: `/language/英文` },
        ],
        view: r.Articles,
    };
