...
const a = async (a) => {
        let { id: o = `915` } = a.req.param(),
            s = a.req.query(`limit`) ? Number.parseInt(a.req.query(`limit`), 10) : 18,
            c = `https://www.nfra.gov.cn`,
            l = new URL(`cn/static/data/DocInfo/SelectDocByItemIdAndChild/data_itemId=${o},pageIndex=1,pageSize=18.json`, c).href,
            u = new URL(`cn/static/data/item/getItemBread/data_itemId=${o}.json`, c).href,
            d = (await e(u)).data.find((e) => String(e.itemId) === o),
            f = new URL(`cn/view/pages/ItemList.html?itemPId=${d.itemPid}&itemId=${o}&itemUrl=ItemListRightList.html`, c).href,
            p = (await e(l)).data.rows.slice(0, s).map((e) => {
                let t = e.docTitle,
                    i = e.docSubtitle,
                    a = e.docId;
                return {
                    title: t,
                    description: i,
                    pubDate: r(n(e.publishDate), 8),
                    link: new URL(`cn/view/pages/ItemDetail.html?docId=${a}`, c).href,
                    guid: a,
                    id: a,
                    content: { html: i, text: i },
                    enclosure_url: new URL(e.pdfFileUrl, c).href,
        ...
        p = await Promise.all(
            p.map((a) =>
                t.tryGet(a.link, async () => {
                    let t = new URL(`cn/static/data/DocInfo/SelectByDocId/data_docId=${a.guid}.json`, c).href,
                        o = (await e(t)).data,
                        s = i(o.docClob),
                        l = o.docTitle,
                        u = s(`div.Section0`).html();
                    return (
                        (a.title = l),
                        (a.description = u),
                        (a.pubDate = r(n(o.publishDate), 8)),
                        (a.category = o.listTwoItem?.[0]?.ItemLvs.map((e) => e.itemName)),
                        (a.author = o.docSource),
                        (a.guid = `cbirc-${a.guid}`),
                        (a.id = a.guid),
                        (a.content = { html: u, text: s(`div.Section0`).text() }),
                        (a.updated = n(o.docEditdate)),
                        (a.language = s(`html`).prop(`lang`) || ``),
                        a
                    );
                })
            )
        ...
        let m = i(await e(f));
        m(`a.lyxd`).remove();
        let h = m(`html`).prop(`lang`) || ``,
            g = m(`div.header-left img`).prop(`src`),
            _ = g ? new URL(g, c).href : ``;
        return { title: `${m(`title`).text()} - ${d.itemName}`, description: d.desc, link: f, item: p, allowEmpty: !0, image: _, author: d.type, language: h };
    },
    o = {
        path: `/cbirc/:id?`,
        name: `分类`,
        ...
        radar: [
            {
                ...
                target: (e, t) => {
                    let n = new URL(t.toString()).searchParams.get(`itemId`);
                    return `/gov/cbirc${n ? `/${n}` : ``}`;
                },
            },
            { title: `首页 - 弹出公告`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/972` },
            { title: `首页 - 法律声明`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4128` },
            { title: `机构概况 - 主要职责`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/901` },
            { title: `机构概况 - 总局领导`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/902` },
            { title: `机构概况 - 内设机构`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/911` },
            { title: `机构概况 - 直属行政机构`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4243` },
            { title: `机构概况 - 派出机构`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/912` },
            { title: `机构概况 - 联系方式`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/913` },
            { title: `新闻资讯 - 监管动态`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/915` },
            { title: `新闻资讯 - 政策解读`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/916` },
            { title: `新闻资讯 - 领导活动及讲话`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/919` },
            { title: `新闻资讯 - 新闻发布会及访谈`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/920` },
            { title: `新闻资讯 - 新闻发言人`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/921` },
            { title: `政务信息 - 政府信息公开`, source: [`www.cbirc.gov.cn/cn/view/pages/zhengwuxinxi/zhengfuxinxi.html`], target: `/cbirc/924` },
            { title: `政务信息 - 公告通知`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/925` },
            { title: `政务信息 - 政策法规`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/926` },
            { title: `政务信息 - 行政许可`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/930` },
            { title: `政务信息 - 行政处罚`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/931` },
            { title: `政务信息 - 行政监管措施`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/932` },
            { title: `政务信息 - 人事信息`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/933` },
            { title: `在线服务 - 行政许可办事服务指南`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/938` },
            { title: `在线服务 - 查询服务`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/939` },
            { title: `互动交流 - 政务咨询`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/946` },
            { title: `互动交流 - 征集调查`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/950` },
            { title: `互动交流 - 国务院办公厅开通"国家政务服务投诉与建议"小程序`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/952` },
            { title: `统计数据 - 统计信息`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/954` },
            { title: `统计数据 - 数据图表`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/955` },
            { title: `专题专栏 - 推进普惠金融高质量发展`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4234` },
            { title: `专题专栏 - 防范和处置非法集资`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/963` },
            { title: `专题专栏 - 消费者保护`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4097` },
            { title: `专题专栏 - 法治宣传`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4106` },
            { title: `专题专栏 - 政府网站年度报表`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/970` },
            { title: `专题专栏 - 服务民营企业`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4171` },
            { title: `专题专栏 - 服务制造业发展`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4217` },
            { title: `专题专栏 - 学习贯彻习近平新时代中国特色社会主义思想主题教育`, source: [`www.cbirc.gov.cn/cn/view/pages/ItemList.html`], target: `/cbirc/4229` },
        ],
    };
