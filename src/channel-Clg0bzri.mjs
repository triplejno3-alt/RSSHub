...
const c = (e) => {
        let t = {},
            n = (e, r = ``, i, a) => {
                let o = r ? `${r}/${e.name}` : e.name,
                    s = e.url || i,
                    c = e.api || e.children?.[0]?.api,
                    l = a || s.split(`/channel/`).pop();
                if ((s && c && (t[o] = { url: s, apiUrl: c, short: l || `` }), e.children && e.children.length > 0)) for (let t of e.children) n(t, o, s, l);
            };
        for (let t of e) n(t);
        return t;
    },
    l = async (a) => {
        let { name: l = `热点` } = a.req.param(),
            u = Number.parseInt(a.req.query(`limit`) ?? `30`, 10),
            d = `m.21jingji.com`,
            f = `https://${d}`,
            p = new URL(`m/webMenu.json`, `https://static.21jingji.com`).href,
            m = c(await e(p));
        if (!m.hasOwnProperty(l)) throw new o(`Invalid channel name`);
        let h = m[l],
            g = new URL(h.apiUrl, f).href,
            _ = new URL(`#/${h.url}`, f).href,
            v = new URL(`reader/cbhChannelAuth`, f).href,
            y = s(await e(_)),
            b = y(`html`).attr(`lang`) ?? `zh-CN`,
            x = await e(v, { method: `POST`, responseType: `json` }),
            S = await e(g, { query: { short: h.short, type: `json`, page: 1 }, headers: { authorization: x.token, host: d, referer: f } }),
            C = [];
        ((C = JSON.parse(S)
            .slice(0, u)
            .map((e) => {
                let t = e.title,
                    a = e.inputtime,
                    o = e.url,
                    s = [...new Set((e.keywords ?? ``)?.split(/,/).filter(Boolean))],
                    c = [...new Set([e.mp?.name, e.author, e.editor, e.source].filter(Boolean))].map((e) => ({ name: e })),
                    l = `21jingji-${e.id}`,
                    u = e.image ?? e.thumb ?? e.listthumb,
                    d = e.updatetime;
                return { title: t, pubDate: a ? i(n(a), 8) : void 0, link: o, category: s, author: c, guid: l, id: l, image: u, banner: u, updated: d ? r(d, `X`) : void 0, language: b };
            })),
            (C = (
                await Promise.all(
                    C.map((n) =>
                        n.link
                            ? t.tryGet(n.link, async () => {
                                  ...
                                  (t(`div.rela-box`).remove(), t(`div.copyright`).remove());
                                  let a = t(`div.titleHead h1`).text(),
                                      o = t(`div.main_content, div.txtContent`).html() ?? ``,
                                      c = t(`div.author-infos span`)
                                          .text()
                                          .match(/(\d{4}-\d{2}-\d{2}\s\d{2}:\d{2})/)?.[1],
                                      l = t(`meta[name="keywords"]`).attr(`content`)?.split(/,/) ?? n.category ?? [],
                                      u = c,
                                      d = { title: a, description: o, pubDate: c ? i(r(c), 8) : n.pubDate, category: l, content: { html: o, text: o }, updated: u ? i(r(u), 8) : n.updated, language: b };
                                  return { ...n, ...d };
                              })
                            : n
                    )
        ...
        let w = y(`title`).text();
        return { title: `${w} - ${l}`, description: y(`meta[name=description]`).attr(`content`), link: _, item: C, allowEmpty: !0, author: w, language: b, id: _ };
    },
    u = {
        path: `/channel/:name{.+}?`,
        name: `频道`,
        ...
        parameters: { category: `分类，默认为热点，可在对应分类页 URL 中找到` },
        description: `::: tip
...
`,
        ...
        radar: [
            { title: `热点`, source: [`m.21jingji.com/#/`], target: `/channel/热点` },
            { title: `投资通`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通` },
            { title: `投资通/推荐`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/推荐` },
            { title: `投资通/盘前情报`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/盘前情报` },
            { title: `投资通/公司洞察`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/公司洞察` },
            { title: `投资通/南财研选`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/南财研选` },
            { title: `投资通/龙虎榜`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/龙虎榜` },
            { title: `投资通/公告精选`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/公告精选` },
            { title: `投资通/牛熊透视`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/牛熊透视` },
            { title: `投资通/一周前瞻`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/一周前瞻` },
            { title: `投资通/财经日历`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/财经日历` },
            { title: `投资通/风口掘金`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/风口掘金` },
            { title: `投资通/实时解盘`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/实时解盘` },
            { title: `投资通/调研内参`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/调研内参` },
            { title: `投资通/趋势前瞻`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/趋势前瞻` },
            { title: `投资通/硬核选基`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/硬核选基` },
            { title: `投资通/3分钟理财`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/3分钟理财` },
            { title: `投资通/AI智讯`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/AI智讯` },
            { title: `投资通/北向资金`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投资通/北向资金` },
            { title: `金融`, source: [`m.21jingji.com/#/channel/finance`], target: `/channel/金融` },
            { title: `金融/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/动态` },
            { title: `金融/最保险`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/最保险` },
            { title: `金融/资管`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/资管` },
            { title: `金融/数字金融`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/数字金融` },
            { title: `金融/私人银行`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/私人银行` },
            { title: `金融/普惠`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/普惠` },
            { title: `金融/观债`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/观债` },
            { title: `金融/金融研究`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/金融研究` },
            { title: `金融/投教基地`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/投教基地` },
            { title: `金融/银行`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/银行` },
            { title: `金融/非银金融`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/非银金融` },
            { title: `金融/金融人事`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/金融/金融人事` },
            { title: `宏观`, source: [`m.21jingji.com/#/channel/politics`], target: `/channel/宏观` },
            { title: `学习经济`, source: [`m.21jingji.com/#/jujiao/xxjjIndexV3`], target: `/channel/学习经济` },
            { title: `学习经济/经济思想`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/经济思想` },
            { title: `学习经济/学习经济卡片`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/学习经济卡片` },
            { title: `学习经济/高质量发展`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/高质量发展` },
            { title: `学习经济/经济政策`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/经济政策` },
            { title: `学习经济/广东在行动`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/广东在行动` },
            { title: `学习经济/数说经济`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/数说经济` },
            { title: `学习经济/学习视频`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/学习视频` },
            { title: `学习经济/学习党史`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/学习经济/学习党史` },
            { title: `大湾区`, source: [`m.21jingji.com/#/channel/GHM_GreaterBay`], target: `/channel/大湾区` },
            { title: `大湾区/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/动态` },
            { title: `大湾区/湾区金融`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/湾区金融` },
            { title: `大湾区/大湾区直播室`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/大湾区直播室` },
            { title: `大湾区/高成长企业`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/高成长企业` },
            { title: `大湾区/产业地理`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/产业地理` },
            { title: `大湾区/数智湾区`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/数智湾区` },
            { title: `大湾区/湾区金融大咖会`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/湾区金融大咖会` },
            { title: `大湾区/“港”创科25人`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/“港”创科25人` },
            { title: `大湾区/湾区论坛`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/大湾区/湾区论坛` },
            { title: `证券`, source: [`m.21jingji.com/#/channel/capital`], target: `/channel/证券` },
            { title: `证券/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/证券/动态` },
            { title: `证券/赢基金`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/证券/赢基金` },
            { title: `证券/券业观察`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/证券/券业观察` },
            { title: `证券/期市一线`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/证券/期市一线` },
            { title: `证券/ETF`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/证券/ETF` },
            { title: `汽车`, source: [`m.21jingji.com/#/channel/auto`], target: `/channel/汽车` },
            { title: `汽车/热闻`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/热闻` },
            { title: `汽车/新汽车`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/新汽车` },
            { title: `汽车/车访间`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/车访间` },
            { title: `汽车/财说车`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/财说车` },
            { title: `汽车/汽车人`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/汽车人` },
            { title: `汽车/汽车商业地理`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/汽车商业地理` },
            { title: `汽车/汽车金融`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/汽车金融` },
            { title: `汽车/行业报告`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/行业报告` },
            { title: `汽车/聚焦`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/汽车/聚焦` },
            { title: `观点`, source: [`m.21jingji.com/#/channel/opinion`], target: `/channel/观点` },
            { title: `新健康`, source: [`m.21jingji.com/#/channel/healthnews`], target: `/channel/新健康` },
            { title: `新健康/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/动态` },
            { title: `新健康/21健讯Daily`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/21健讯Daily` },
            { title: `新健康/21CC`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/21CC` },
            { title: `新健康/21健谈`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/21健谈` },
            { title: `新健康/名医说`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/名医说` },
            { title: `新健康/数字医疗`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/数字医疗` },
            { title: `新健康/21H院长对话`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/21H院长对话` },
            { title: `新健康/医健IPO解码`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/医健IPO解码` },
            { title: `新健康/研究报告`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/研究报告` },
            { title: `新健康/21科普`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/新健康/21科普` },
            { title: `ESG`, source: [`m.21jingji.com/#/channel/esg`], target: `/channel/ESG` },
            { title: `ESG/ESG发布厅`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/ESG发布厅` },
            { title: `ESG/绿色公司`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/绿色公司` },
            { title: `ESG/绿色金融`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/绿色金融` },
            { title: `ESG/净零碳城市`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/净零碳城市` },
            { title: `ESG/碳市场`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/碳市场` },
            { title: `ESG/生物多样性`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/生物多样性` },
            { title: `ESG/行业周报`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/行业周报` },
            { title: `ESG/研究报告`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/ESG/研究报告` },
            { title: `全球市场`, source: [`m.21jingji.com/#/channel/global`], target: `/channel/全球市场` },
            { title: `全球市场/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/动态` },
            { title: `全球市场/全球财经连线`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/全球财经连线` },
            { title: `全球市场/直击华尔街`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/直击华尔街` },
            { title: `全球市场/百家跨国公司看中国`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/百家跨国公司看中国` },
            { title: `全球市场/全球央行观察`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/全球央行观察` },
            { title: `全球市场/全球能源观察`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/全球能源观察` },
            { title: `全球市场/美股一线`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/美股一线` },
            { title: `全球市场/港股一线`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/港股一线` },
            { title: `全球市场/全球金融观察`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/全球金融观察` },
            { title: `全球市场/联合国现场`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/联合国现场` },
            { title: `全球市场/全球央行月报`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/全球央行月报` },
            { title: `全球市场/全球商品观察`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/全球市场/全球商品观察` },
            { title: `一带一路`, source: [`m.21jingji.com/#/channel/BandR`], target: `/channel/一带一路` },
            { title: `数读`, source: [`m.21jingji.com/#/channel/readnumber`], target: `/channel/数读` },
            { title: `理财通`, source: [`m.21jingji.com/#/channel/financing`], target: `/channel/理财通` },
            { title: `理财通/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/动态` },
            { title: `理财通/数据库`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/数据库` },
            { title: `理财通/研报`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/研报` },
            { title: `理财通/投教`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/投教` },
            { title: `理财通/政策`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/政策` },
            { title: `理财通/固收+`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/固收+` },
            { title: `理财通/纯固收`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/纯固收` },
            { title: `理财通/现金`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/现金` },
            { title: `理财通/混合`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/混合` },
            { title: `理财通/权益`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/理财通/权益` },
            { title: `直播`, source: [`m.21jingji.com/#/channel/live`], target: `/channel/直播` },
            { title: `长三角`, source: [`m.21jingji.com/#/channel/yangtzeriverdelta`], target: `/channel/长三角` },
            { title: `论坛活动`, source: [`m.21jingji.com/#/channel/market`], target: `/channel/论坛活动` },
            { title: `创投`, source: [`m.21jingji.com/#/channel/entrepreneur`], target: `/channel/创投` },
            { title: `投教`, source: [`m.21jingji.com/#/channel/tjzjy`], target: `/channel/投教` },
            { title: `投教/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投教/动态` },
            { title: `投教/投教知识`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投教/投教知识` },
            { title: `投教/公益活动`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/投教/公益活动` },
            { title: `海洋经济`, source: [`m.21jingji.com/#/channel/oceaneconomy`], target: `/channel/海洋经济` },
            { title: `数字合规`, source: [`m.21jingji.com/#/channel/compliance`], target: `/channel/数字合规` },
            { title: `公司`, source: [`m.21jingji.com/#/channel/company`], target: `/channel/公司` },
            { title: `公司/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/动态` },
            { title: `公司/电子通信`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/电子通信` },
            { title: `公司/互联网`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/互联网` },
            { title: `公司/高端制造`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/高端制造` },
            { title: `公司/新能源`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/新能源` },
            { title: `公司/消费`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/消费` },
            { title: `公司/地产基建`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/地产基建` },
            { title: `公司/IPO`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/IPO` },
            { title: `公司/文旅`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/公司/文旅` },
            { title: `人文`, source: [`m.21jingji.com/#/channel/life`], target: `/channel/人文` },
            { title: `SFC Global`, source: [`m.21jingji.com/#/channel/SFCGlobal`], target: `/channel/SFC Global` },
            { title: `SFC Global/News`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/SFC Global/News` },
            { title: `SFC Global/SFC Markets and Finance`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/SFC Global/SFC Markets and Finance` },
            { title: `SFC Global/SFC Market Talk`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/SFC Global/SFC Market Talk` },
            { title: `SFC Global/CBN`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/SFC Global/CBN` },
            { title: `SFC Global/Multinationals on China`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/SFC Global/Multinationals on China` },
            { title: `SFC Global/Companies in the GBA`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/SFC Global/Companies in the GBA` },
            { title: `南方财经报道`, source: [`m.21jingji.com/#/channel/nfcjbd`], target: `/channel/南方财经报道` },
            { title: `专题`, source: [`m.21jingji.com/#/jujiao`], target: `/channel/专题` },
            { title: `链上预制菜`, source: [`m.21jingji.com/#/channel/precookedfood`], target: `/channel/链上预制菜` },
            { title: `链上预制菜/动态`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/链上预制菜/动态` },
            { title: `链上预制菜/活动`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/链上预制菜/活动` },
            { title: `链上预制菜/报道`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/链上预制菜/报道` },
            { title: `链上预制菜/智库/课题`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/链上预制菜/智库/课题` },
            { title: `链上预制菜/数据/创新案例`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/链上预制菜/数据/创新案例` },
            { title: `链上预制菜/链接平台`, source: [`m.21jingji.com/#/channel/investment`], target: `/channel/链上预制菜/链接平台` },
        ],
        view: a.Articles,
    };
