...
const a = async (a) => {
        let { category: o = `latest` } = a.req.param(),
            s = a.req.query(`limit`) ? Number.parseInt(a.req.query(`limit`), 10) : 30,
            c = `https://www.sse.com.cn`,
            l = new URL(`lawandrules/sselawsrules/${o}`, c).href,
            { data: u } = await n(l),
            d = i(u),
            f = d(`div#sse_list_1 dl dd`)
                .slice(0, s)
                .toArray()
                .map((e) => ((e = d(e)), { title: e.find(`a`).text().trim(), pubDate: t(e.find(`span`).text().trim()), link: new URL(e.find(`a`).prop(`href`), c).href }));
        f = await Promise.all(
            f.map((a) =>
                e.tryGet(a.link, async () => {
                    let { data: e } = await n(a.link),
                        o = i(e),
                        s = o(`div.article-infor h2`).text().trim(),
                        c = o(`div.allZoom`).html();
                    return (
                        (a.title = s),
                        (a.description = c),
                        (a.pubDate = t(o(`div.article_opt i`).text().trim())),
                        (a.author = o(`meta[name="author"]`).prop(`content`)),
                        (a.content = { html: c, text: o(`div.allZoom`).text() }),
                        (a.updated = o(`meta[name="others"]`).prop(`content`)
                            ? r(
                                  t(
                                      o(`meta[name="others"]`)
                                          .prop(`content`)
        ...
        let p = new URL(d(`img.sse_logo`).prop(`content`), c).href;
        return { title: d(`title`).text(), description: d(`meta[name="description"]`).prop(`content`), link: l, item: f, allowEmpty: !0, image: p, author: d(`meta[name="author"]`).prop(`content`) };
    },
    o = {
        ...
        radar: [
            {
                ...
                target: (e) => {
                    let t = e.category;
                    return `/sse/sselawsrules${t ? `/${t}` : ``}`;
                },
            },
            { title: `最新规则`, source: [`www.sse.com.cn/lawandrules/sselawsrules/latest/`], target: `/sselawsrules/latest` },
            { title: `章程`, source: [`www.sse.com.cn/lawandrules/sselawsrules/article/`], target: `/sselawsrules/article` },
            { title: `首发`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/review/firstepisode/`], target: `/sselawsrules/stocks/review/firstepisode` },
            { title: `再融资`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/review/refinancing/`], target: `/sselawsrules/stocks/review/refinancing` },
            { title: `重组`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/review/recombination/`], target: `/sselawsrules/stocks/review/recombination` },
            { title: `转板`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/review/flap/`], target: `/sselawsrules/stocks/review/flap` },
            { title: `发行承销`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/issue/`], target: `/sselawsrules/stocks/issue` },
            { title: `主板上市（挂牌）`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/mainipo/`], target: `/sselawsrules/stocks/mainipo` },
            { title: `科创板上市（挂牌）`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/staripo/`], target: `/sselawsrules/stocks/staripo` },
            { title: `股票交易`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/exchange/`], target: `/sselawsrules/stocks/exchange` },
            { title: `试点创新企业`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/innovative/`], target: `/sselawsrules/stocks/innovative` },
            { title: `股权分置改革`, source: [`www.sse.com.cn/lawandrules/sselawsrules/stocks/reform/`], target: `/sselawsrules/stocks/reform` },
            { title: `发行上市审核`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/review/`], target: `/sselawsrules/bond/review` },
            { title: `发行承销`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/issue/`], target: `/sselawsrules/bond/issue` },
            { title: `公司债券上市（挂牌）`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/listing/corporatebond/`], target: `/sselawsrules/bond/listing/corporatebond` },
            { title: `资产支持证券上市（挂牌）`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/listing/assets/`], target: `/sselawsrules/bond/listing/assets` },
            { title: `债券交易通用`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/trading/currency/`], target: `/sselawsrules/bond/trading/currency` },
            { title: `国债预发行`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/trading/tbondp/`], target: `/sselawsrules/bond/trading/tbondp` },
            { title: `债券质押式三方回购`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/trading/tripartyrepo/`], target: `/sselawsrules/bond/trading/tripartyrepo` },
            { title: `债券质押式协议回购`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/trading/repurchase/`], target: `/sselawsrules/bond/trading/repurchase` },
            { title: `国债买断式回购交易`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/trading/outrightrepo/`], target: `/sselawsrules/bond/trading/outrightrepo` },
            { title: `信用保护工具`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/trading/cdx/`], target: `/sselawsrules/bond/trading/cdx` },
            { title: `上市公司可转债`, source: [`www.sse.com.cn/lawandrules/sselawsrules/bond/convertible/`], target: `/sselawsrules/bond/convertible` },
            { title: `基金上市`, source: [`www.sse.com.cn/lawandrules/sselawsrules/fund/listing/`], target: `/sselawsrules/fund/listing` },
            { title: `基金交易`, source: [`www.sse.com.cn/lawandrules/sselawsrules/fund/trading/`], target: `/sselawsrules/fund/trading` },
            { title: `基础设施公募REITs`, source: [`www.sse.com.cn/lawandrules/sselawsrules/reits/`], target: `/sselawsrules/reits` },
            { title: `期权`, source: [`www.sse.com.cn/lawandrules/sselawsrules/option/`], target: `/sselawsrules/option` },
            { title: `通用类`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/universal/`], target: `/sselawsrules/trade/universal` },
            { title: `融资融券`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/margin/`], target: `/sselawsrules/trade/specific/margin` },
            { title: `转融通`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/refinancing/`], target: `/sselawsrules/trade/specific/refinancing` },
            { title: `质押式回购`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/repo/`], target: `/sselawsrules/trade/specific/repo` },
            { title: `质押式报价回购`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/pricerepo/`], target: `/sselawsrules/trade/specific/pricerepo` },
            { title: `约定购回`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/promise/`], target: `/sselawsrules/trade/specific/promise` },
            { title: `协议转让`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/xyzr/`], target: `/sselawsrules/trade/specific/xyzr` },
            { title: `其他`, source: [`www.sse.com.cn/lawandrules/sselawsrules/trade/specific/others/`], target: `/sselawsrules/trade/specific/others` },
            { title: `沪港通`, source: [`www.sse.com.cn/lawandrules/sselawsrules/global/hkexsc/`], target: `/sselawsrules/global/hkexsc` },
            { title: `互联互通存托凭证`, source: [`www.sse.com.cn/lawandrules/sselawsrules/global/slsc/`], target: `/sselawsrules/global/slsc` },
            { title: `会员管理`, source: [`www.sse.com.cn/lawandrules/sselawsrules/member/personnel/`], target: `/sselawsrules/member/personnel` },
            { title: `适当性管理`, source: [`www.sse.com.cn/lawandrules/sselawsrules/member/adequacy/`], target: `/sselawsrules/member/adequacy` },
            { title: `纪律处分与复核`, source: [`www.sse.com.cn/lawandrules/sselawsrules/disciplinary/`], target: `/sselawsrules/disciplinary` },
            { title: `交易收费`, source: [`www.sse.com.cn/lawandrules/sselawsrules/charge/`], target: `/sselawsrules/charge` },
            { title: `其他业务规则`, source: [`www.sse.com.cn/lawandrules/sselawsrules/other/`], target: `/sselawsrules/other` },
            { title: `业务规则废止公告`, source: [`www.sse.com.cn/lawandrules/sserules/repeal/announcement/`], target: `/sselawsrules//lawandrules/sserules/repeal/announcement` },
            { title: `已废止规则文本`, source: [`www.sse.com.cn/lawandrules/sselawsrules/repeal/rules/`], target: `/sselawsrules/repeal/rules` },
        ],
    };
