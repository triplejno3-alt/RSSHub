...
const a = async (r) => {
        let { category: a = `ywgg/tzgg` } = r.req.param(),
            o = Number.parseInt(r.req.query(`limit`) ?? `15`, 10),
            s = `https://www.cccmc.org.cn`,
            ...
            l
                ...
                .map((e) => {
                    let t = e.match(/'(.*?)'/),
                        ...
                        a = t?.[1],
                        o = i;
                    return { title: r, pubDate: i ? n(i) : void 0, link: a ? new URL(a, s).href : void 0, updated: o ? n(o) : void 0, language: d };
                }) ?? []),
            (f = (
                await Promise.all(
                    f.map((r) =>
                        r.link
                            ? t.tryGet(r.link, async () => {
                                  let t = i(await e(r.link)),
                                      a = t(`div.title`).text(),
                                      o = t(`div#article-content`).html() ?? ``,
                                      s = t(`span.time`).text().split(/：/).pop(),
                                      c = t(`span.form, span.from`)
                                          .toArray()
                                          .map((e) => {
                                              let n = t(e);
                                              return { name: n.text().split(/：/).pop() ?? n.text() };
                                          }),
                                      l = s,
                                      u = { title: a, description: o, pubDate: s ? n(s) : r.pubDate, author: c, content: { html: o, text: o }, updated: l ? n(l) : r.updated, language: d };
                                  return { ...r, ...u };
                              })
                            : r
                    )
        ...
        let p = u(`title`).text();
        return { title: p, description: p.split(/-/)[0].trim(), link: c, item: f, allowEmpty: !0, image: u(`img.logo`).attr(`src`), author: p.split(/-/)?.pop()?.trim(), language: d, id: c };
    },
    o = {
        path: `/:category{.+}?`,
        name: `通用`,
        ...
        parameters: { category: '分类，默认为 `ywgg/tzgg`，即通知公告，可在对应分类页 URL 中找到, Category, `ywgg/tzgg`，即通知公告  by default' },
        description: `::: tip
...
`,
        ...
        radar: [
            ...
            { title: `商业机会 - 供应信息`, source: [`www.cccmc.org.cn/syjh/gyxx/`], target: `/syjh/gyxx` },
            { title: `商业机会 - 需求信息`, source: [`www.cccmc.org.cn/syjh/xqxx/`], target: `/syjh/xqxx` },
            { title: `商业机会 - 合作信息`, source: [`www.cccmc.org.cn/syjh/hzxx/`], target: `/syjh/hzxx` },
            { title: `商会党建 - 党群动态`, source: [`www.cccmc.org.cn/shdj/dqdt/`], target: `/shdj/dqdt` },
            { title: `商会党建 - 党内法规`, source: [`www.cccmc.org.cn/shdj/dnfg/`], target: `/shdj/dnfg` },
            { title: `商会党建 - 青年工作`, source: [`www.cccmc.org.cn/shdj/qngz/`], target: `/shdj/qngz` },
            { title: `行业资讯 - 统计分析`, source: [`www.cccmc.org.cn/hyzx/tjfx/`], target: `/hyzx/tjfx` },
            { title: `行业资讯 - 石油化工`, source: [`www.cccmc.org.cn/hyzx/syhg/`], target: `/hyzx/syhg` },
            { title: `行业资讯 - 金属矿产`, source: [`www.cccmc.org.cn/hyzx/jskc/`], target: `/hyzx/jskc` },
            { title: `行业资讯 - 五金建材`, source: [`www.cccmc.org.cn/hyzx/wjjc/`], target: `/hyzx/wjjc` },
            { title: `会员之家 - 会员之声`, source: [`www.cccmc.org.cn/hyzj/hyzs/`], target: `/hyzj/hyzs` },
            { title: `会员之家 - 会员动态`, source: [`www.cccmc.org.cn/hyzj/hydt/`], target: `/hyzj/hydt` },
            { title: `会员之家 - 会员推介`, source: [`www.cccmc.org.cn/hyzj/hytj/`], target: `/hyzj/hytj` },
            { title: `政策法规 - 综合政策`, source: [`www.cccmc.org.cn/zcfg/zhzc/`], target: `/zcfg/zhzc` },
            { title: `政策法规 - 国内贸易`, source: [`www.cccmc.org.cn/zcfg/gnmy/`], target: `/zcfg/gnmy` },
            { title: `政策法规 - 对外贸易`, source: [`www.cccmc.org.cn/zcfg/dwmy/`], target: `/zcfg/dwmy` },
            { title: `政策法规 - 投资合作`, source: [`www.cccmc.org.cn/zcfg/tzhz/`], target: `/zcfg/tzhz` },
        ],
        view: r.Articles,
    };
