...
const a = async (a) => {
        let { category: o = `html/xinwen/index` } = a.req.param(),
            s = a.req.query(`limit`) ? Number.parseInt(a.req.query(`limit`), 10) : 25,
            c = `https://www.lswz.gov.cn`,
            ...
            p = d(`ul.lists li`)
                .slice(0, s)
                .toArray()
                .map((e) => ((e = d(e)), { title: e.find(`a`).text(), pubDate: t(e.find(`span`).text()), link: new URL(e.find(`a`).prop(`href`), c).href }));
        p = await Promise.all(
            p.map((a) =>
                e.tryGet(a.link, async () => {
                    let { data: e } = await n(a.link),
                        o = i(e);
                    (o(`ul.lists`).remove(), o(`div.pub-right-source, div.detail_links_pane`).remove());
                    let s = o(`meta[name="ArticleTitle"]`).prop(`content`) || o(`div.pub-det-title`).text(),
                        c = o(`table.pages_content, div.article-content, div.TRS_UEDITOR, div.TRS_PreAppend`).html(),
                        l = o(`meta[name="PubDate"]`).prop(`content`);
                    return (
                        (a.title = s || a.title),
                        (a.description = c),
                        (a.pubDate = l ? r(t(l), 8) : a.pubDate),
                        (a.author = o(`meta[name="ContentSource"]`).prop(`content`)?.trim() ?? void 0),
                        (a.content = { html: c, text: o(`table.pages_content, div.article-content, div.TRS_UEDITOR, div.TRS_PreAppend`).text() }),
                        (a.language = f),
                        a
                    );
                })
        ...
        let m = new URL(d(`div.lsj-index-logo img`).prop(`src`), c).href;
        return { title: d(`title`).text(), description: d(`meta[name="ColumnDescription"]`).prop(`content`), link: l, item: p, allowEmpty: !0, image: m, author: d(`meta[name="SiteName"]`).prop(`content`), language: f };
    },
    o = {
        path: `/lswz/:category{.+}?`,
        name: `国家粮食和物资储备局`,
...
| [html/zmhd/lysj/lsjg-scjc](https://rsshub.app/gov/lswz/html/zmhd/lysj/lsjg-scjc) | [html/zmhd/lysj/lsjg-scjg](https://rsshub.app/gov/lswz/html/zmhd/lysj/lsjg-scjg) |
  ...
  `,
        ...
        radar: [
            ...
            { title: `新闻发布`, source: [`www.lswz.gov.cn/html/xinwen/index.shtml`], target: `/lswz/html/xinwen/index` },
            { title: `党建工作`, source: [`www.lswz.gov.cn/html/djgz/index.shtml`], target: `/lswz/html/djgz/index` },
            { title: `业务频道 - 粮食调控`, source: [`www.lswz.gov.cn/html/ywpd/lstk/index.shtml`], target: `/lswz/html/ywpd/lstk/index` },
            { title: `业务频道 - 物资储备`, source: [`www.lswz.gov.cn/html/ywpd/wzcb/index.shtml`], target: `/lswz/html/ywpd/wzcb/index` },
            { title: `业务频道 - 能源储备`, source: [`www.lswz.gov.cn/html/ywpd/nycb/index.shtml`], target: `/lswz/html/ywpd/nycb/index` },
            { title: `业务频道 - 安全应急`, source: [`www.lswz.gov.cn/html/ywpd/aqyj/index.shtml`], target: `/lswz/html/ywpd/aqyj/index` },
            { title: `业务频道 - 法规体改`, source: [`www.lswz.gov.cn/html/ywpd/fgtg/index.shtml`], target: `/lswz/html/ywpd/fgtg/index` },
            { title: `业务频道 - 规划建设`, source: [`www.lswz.gov.cn/html/ywpd/gjks/index.shtml`], target: `/lswz/html/ywpd/gjks/index` },
            { title: `业务频道 - 财务审计`, source: [`www.lswz.gov.cn/html/ywpd/cwsj/index.shtml`], target: `/lswz/html/ywpd/cwsj/index` },
            { title: `业务频道 - 仓储科技`, source: [`www.lswz.gov.cn/html/ywpd/cckj/index.shtml`], target: `/lswz/html/ywpd/cckj/index` },
            { title: `业务频道 - 执法督查`, source: [`www.lswz.gov.cn/html/ywpd/zfdc/index.shtml`], target: `/lswz/html/ywpd/zfdc/index` },
            { title: `业务频道 - 国际交流`, source: [`www.lswz.gov.cn/html/ywpd/gjjl/index.shtml`], target: `/lswz/html/ywpd/gjjl/index` },
            { title: `业务频道 - 人事人才`, source: [`www.lswz.gov.cn/html/ywpd/rsrc/index.shtml`], target: `/lswz/html/ywpd/rsrc/index` },
            { title: `业务频道 - 标准质量`, source: [`www.lswz.gov.cn/html/ywpd/bzzl/index.shtml`], target: `/lswz/html/ywpd/bzzl/index` },
            { title: `业务频道 - 粮食和储备研究`, source: [`www.lswz.gov.cn/html/ywpd/lshcbyj/index.shtml`], target: `/lswz/html/ywpd/lshcbyj/index` },
            { title: `政策发布 - 文件`, source: [`www.lswz.gov.cn/html/zcfb/wenjian.shtml`], target: `/lswz/html/zcfb/wenjian` },
            { title: `政策发布 - 法律法规`, source: [`www.lswz.gov.cn/html/zcfb/fggz-fg.shtml`], target: `/lswz/html/zcfb/fggz-fg` },
            { title: `政策发布 - 规章`, source: [`www.lswz.gov.cn/html/zcfb/fggz-gz.shtml`], target: `/lswz/html/zcfb/fggz-gz` },
            { title: `通知公告 - 行政通知`, source: [`www.lswz.gov.cn/html/tzgg/xztz.shtml`], target: `/lswz/html/tzgg/xztz` },
            { title: `通知公告 - 公告通告`, source: [`www.lswz.gov.cn/html/tzgg/ggtg.shtml`], target: `/lswz/html/tzgg/ggtg` },
            { title: `粮食收购 - 收购数据`, source: [`www.lswz.gov.cn/html/zmhd/lysj/lssg-szym.shtml`], target: `/lswz/html/zmhd/lysj/lssg-szym` },
            { title: `粮食收购 - 政策·解读`, source: [`www.lswz.gov.cn/html/zmhd/lysj/lssg-gzdt.shtml`], target: `/lswz/html/zmhd/lysj/lssg-gzdt` },
            { title: `粮食价格 - 市场监测`, source: [`www.lswz.gov.cn/html/zmhd/lysj/lsjg-scjc.shtml`], target: `/lswz/html/zmhd/lysj/lsjg-scjc` },
            { title: `粮食价格 - 市场价格`, source: [`www.lswz.gov.cn/html/zmhd/lysj/lsjg-scjg.shtml`], target: `/lswz/html/zmhd/lysj/lsjg-scjg` },
            { title: `粮食交易`, source: [`www.lswz.gov.cn/html/zmhd/lysj/lsjy.shtml`], target: `/lswz/html/zmhd/lysj/lsjy` },
            { title: `粮食质量`, source: [`www.lswz.gov.cn/html/zmhd/lysj/lszl.shtml`], target: `/lswz/html/zmhd/lysj/lszl` },
        ],
    };
