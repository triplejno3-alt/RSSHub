import"./ofetch-uhy-qh6X.mjs";import"./config-Cc-zZ5p-.mjs";import"./logger-_vmdpChp.mjs";import"./helpers-C9wXLK0V.mjs";import{t as e}from"./got-CKQ7C9HX.mjs";import{r as t}from"./utils-Bu8-ZFdB.mjs";const n={path:`/partion/:tid/:embed?`,categories:[`social-media`],example:`/bilibili/partion/33`,parameters:{tid:`分区 id`,embed:`默认为开启内嵌视频, 任意值为关闭`},features:{requireConfig:!1,requirePuppeteer:!1,antiCrawler:!1,supportBT:!1,supportPodcast:!1,supportScihub:!1},name:`分区视频`,maintainers:[`DIYgod`],handler:r,description:`动画
