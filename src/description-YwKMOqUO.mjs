            ...
            children: [
                ...
                n(`p`, {
                    children: [
                        ...
                        t(`br`, {}),
                        t(`span`, { children: t(`small`, { children: t(`i`, { children: n(`a`, { href: `https://doi.org/${i.doi}`, children: [`https://doi.org/`, i.doi] }) }) }) }),
                        t(`br`, {}),
                        t(`span`, { children: t(`small`, { children: n(`i`, { children: [`Volume `, i.volume ?? ``] }) }) }),
                        t(`br`, {}),
                    ],
                }),
