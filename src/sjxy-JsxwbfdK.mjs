...
const a = `https://www.qztc.edu.cn/sjxy/`,
    o = {
        path: `/sjxy/:type`,
        ...
        url: `www.qztc.edu.cn`,
        handler: s,
        radar: [{ source: [`www.qztc.edu.cn/sjxy/:type/list.htm`], target: `/sjxy/:type` }],
        description: `| 板块 | 参数 |
| ------- | ------- |
| 学院概况 | 1938 |
| 学院动态 | 1939 |
...
async function s(o) {
        ...
        u = await Promise.all(
            l.map((n) =>
                t.tryGet(n.link, async () => {
                    let t = { ...n, description: `` };
                    return (
                        new URL(n.link).hostname === `www.qztc.edu.cn`
    ...
    return { title: c(`head > title`).text() + ` - 泉州师范学院-数学与计算机科学学院 软件学院`, link: a + s + `/list.htm`, item: u };
}
export { o as route };
