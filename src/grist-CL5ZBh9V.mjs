...
const n = { path: `/`, radar: [{ source: [`grist.org/articles/`] }], name: `Latest Articles`, maintainers: [`Rjnishant530`], categories: [`new-media`], example: `/grist`, parameters: {}, handler: r, url: `grist.org/articles/` };
async function r() {
    let n = `https://grist.org`,
        r = await e(await t(`${n}/wp-json/wp/v2/posts?_embed`));
    return {
