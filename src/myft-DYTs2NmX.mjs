...
async function a(i) {
    let a = (e) => (e.find(`div.o-share, aside, div.o-ads`).remove(), e.html()),
        o = `https://www.ft.com/myft/following/${i.req.param(`key`)}.rss`,
        s = await n.parseURL(o);
    return {
        title: `FT.com - myFT`,
        link: o,
        ...
        item: await Promise.all(
            s.items.map((n) =>
                e.tryGet(n.link, async () => {
                    let e = r((await t({ method: `get`, url: n.link, headers: { Referer: `https://www.facebook.com` } })).data);
                    return (
                        (n.description = a(e(`article.js-article__content-body`))),
                        (n.category = [
                            e(`.n-content-tag--with-follow`).text(),
                            ...e(`.article__right-bottom a.concept-list__concept`)
                                .toArray()
                                .map((t) => e(t).text().trim()),
                        ]),
                        (n.author = e(`a.n-content-tag--author`)
                            .toArray()
                            .map((t) => ({ name: e(t).text() }))),
                        n
                    );
