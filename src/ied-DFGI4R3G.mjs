...
async function n(t) {
    await e(t, { baseHost: `https://ied.hunau.edu.cn`, baseCategory: `ggtz`, baseType: `xwzx`, baseTitle: `国际交流与合作处`, baseDescription: `湖南农业大学国际交流与合作处、国际教育学院、港澳台事务办公室`, baseDeparment: `ied` });
}
export { t as route };
