...
`,
                variables: { ...t, source: l, ranking: `TIME`, supportedTypes: [`article`, `share`, `freeform`, `video:youtube`, `collection`, `welcome`], first: a },
            }),
            o,
            !0
        );
    return { title: `${d} - daily.dev`, link: c, item: f, description: u, logo: `${i}/favicon-32x32.png`, icon: `${i}/favicon-32x32.png`, language: `en-us` };
}
export { a as route };
