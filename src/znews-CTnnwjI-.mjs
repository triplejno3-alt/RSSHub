...
async function r(n) {
    let r = n.req.param(`section`),
        i,
        a;
    switch (r) {
        case `singapore`:
            ((i = `新加坡`), (a = `/news/singapore`));
            break;
        case `world`:
            ((i = `国际`), (a = `/news/world`));
            break;
    ...
    return { title: `《联合早报》-${i}-新闻`, link: `https://www.zaobao.com` + a, description: `新加坡、中国、亚洲和国际的即时、评论、商业、体育、生活、科技与多媒体新闻，尽在联合早报。`, image: t, item: o };
}
export { n as route };
