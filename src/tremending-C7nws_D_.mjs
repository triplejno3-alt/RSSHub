...
const r = {
    ...
    radar: [{ source: [`publico.es/tremending`], target: `/tremending` }],
    name: `Tremending`,
    maintainers: [`adrianrico97`],
    handler: i,
};
async function i() {
    let r = `https://www.publico.es/tremending`;
    return { title: `Tremending | Público`, link: r, item: t(n((await e({ method: `get`, url: r })).data)) };
}
export { r as route };
