...
const a = {
    ...
    example: `/ecnu/sei`,
    radar: [{ source: [`sei.ecnu.edu.cn`], target: `/sei` }],
    name: `软件工程学院通知公告`,
    maintainers: [`FrozenStarrrr`, `ChiyoYuki`, `ECNU-minus`],
    handler: async () => {
        let a = `https://sei.ecnu.edu.cn/`,
            o = i((await n(`${a}33171/list.htm`)).data),
            s = o(`ul.data-list > li`)
                .toArray()
                .map((e) => ({ pubDate: r(t(o(e).find(`.data-list-time`).text()), 8), link: new URL(o(e).find(`a`).attr(`href`), a).toString(), title: o(e).find(`a`).text() }));
        return {
            title: `软件工程学院通知公告`,
