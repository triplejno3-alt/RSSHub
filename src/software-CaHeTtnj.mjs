...
const i = {
    ...
    radar: [{ source: [`www.alternativeto.net/software/:name`], target: `/software/:name` }],
...
async function a(i) {
    let a = `https://alternativeto.net/software/${i.req.param(`name`)}/?${new URLSearchParams(i.req.param(`routeParams`)).toString()}`,
        o = r(await t(a, e));
    return {
