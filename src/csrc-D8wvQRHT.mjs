import"./ofetch-uhy-qh6X.mjs";import"./config-Cc-zZ5p-.mjs";import"./logger-_vmdpChp.mjs";import"./helpers-C9wXLK0V.mjs";import{t as e}from"./parse-date-DjdQS_Nt.mjs";import{t}from"./got-CKQ7C9HX.mjs";import{t as n}from"./invalid-parameter-DGZgOgO2.mjs";import{load as r}from"cheerio";const i=async i=>{let{id:a=`c101972`}=i.req.param(),o=i.req.query(`limit`)?Number.parseInt(i.req.query(`limit`),10):50,s=`http://www.csrc.gov.cn`,c=new URL(`getLocalList`,s).href,l=new URL(`/csrc/${a}/zfxxgk_zdgk.shtml`,s).href,{data:u}=await t(c,{searchParams:{channelCode:a}}),d=u.results.channelLevel.find(e=>e.channelCode===a),f=d?.channelId??void 0,p=d?.channelName??void 0;if(!f)throw new n(`Invalid channel Id: ${a}`);let m=new URL(`searchList/${f}`,s).href,{data:h}=await t(m,{searchParams:{_isAgg:!0,_isJson:!0,_pageSize:o}}),g=h.data.results.slice(0,o).map(t=>{let n=t.title,r=t.contentHtml,i=t.resList?.[0]??void 0;return{title:n,description:r,pubDate:e(t.publishedTime),link:t.url,category:[t.channelName],content:{html:r,text:t.content},enclosure_url:i?new URL(i.filePath,s).href:void 0,enclosure_type:i?`application/${i.filePath.split(/\./).pop()}`:void 0,enclosure_title:i?i.title:void 0}}),{data:_}=await t(l),v=r(_),y=p??a,b=new URL(v(`div.zfxx-logo img`).prop(`src`),s).href,x=v(`meta[name="SiteName"]`).prop(`content`);return{title:`${x} - ${y}`,description:y,link:l,item:g,allowEmpty:!0,image:b,author:x}},a={path:`/csrc/zfxxgk_zdgk/:id?`,name:`政府信息公开`,url:`www.csrc.gov.cn`,maintainers:[`nczitzk`],handler:i,example:`/gov/csrc/zfxxgk_zdgk/c101971`,parameters:{id:"频道 id，默认为 `c101971`，即行政处罚决定，可在对应频道页 URL 中找到"},description:`::: tip
