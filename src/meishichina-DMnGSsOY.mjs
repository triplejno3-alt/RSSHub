...
const i = (e) => /^[\u4E00-\u9FA5]+$/.test(e),
    a = async (a) => {
        let o = `最新推荐`,
            { category: s = o } = a.req.param(),
            c = a.req.query(`limit`) ? Number.parseInt(a.req.query(`limit`), 10) : 20,
            l = i(s),
            u = s.startsWith(`recipe`),
            d = `https://home.meishichina.com`,
            f = new URL(`${u ? `` : `recipe`}${l ? `.html` : `/${s.endsWith(`/`) ? s : `${s}${u ? `.html` : `/`}`}`}`, d).href,
            p = new URL(`ajax/ajax.php`, d).href,
            { data: m } = await n(f),
            h = r(m),
            g = l
                ? h(`div#recipeindex_info_wrap a`)
                      .toArray()
                      .find((e) => h(e).text() === s)
                : void 0,
            { data: _ } = l ? await n(p, { searchParams: { ac: `recipe`, op: `getMoreDiffStateRecipeList`, classid: g ? h(g).prop(`data`) : 0, orderby: g ? h(g).prop(`order`) : `hot`, page: 1 } }) : { data: void 0 },
            v = l
                ? _.data.slice(0, c).map((e) => {
                      let n = e.title,
                          r = `meishichina-${e.id}`,
                          i = e.fcover.split(/\?/)[0];
                      return {
                          title: n,
                          pubDate: e.datelines ? t(e.datelines, `X`) : t(e.dateline, `YYYY-M-D`),
                          link: new URL(`recipe-${e.id}.html`, d).href,
                          category: e.mainingredient.replace(/。$/, ``).split(`、`),
                          author: e.username,
                          guid: r,
                          id: r,
                          image: i,
                ...
                : h(`div#J_list ul li`)
                      ...
                      .map((e) => {
                          e = h(e);
                          let t = e.find(`div.detail h2`).text(),
                              n = e.find(`div.detail`).html(),
                              r = `meishichina-${e.prop(`data-id`)}`,
                              i = e.find(`div.pic img`).prop(`src`).split(/\?/)[0];
                          return {
                              title: t,
                              description: n,
                              link: e.find(`div.detail h2 a`).prop(`href`),
                              category: e.find(`p.subcontent`).text().replace(/。$/, ``).split(`、`),
                              author: e.find(`p.subline a`).text(),
                              guid: r,
                              id: r,
                              content: { html: n, text: e.find(`div.detail`).text() },
                              image: i,
                              banner: i,
                          };
                      });
            ...
            v.map((i) =>
                e.tryGet(i.link, async () => {
                    let { data: e } = await n(i.link),
                        a = r(e);
                    (a(`input[type="hidden"]`).remove(), a(`p.J_photo, p.copyright`).remove(), a(`div.sharebox`).nextAll().addBack().remove());
                    let o = a(`a#recipe_title`).text(),
                        s = a(`div.recipDetail`).html(),
                        c = a(`div#recipe_De_imgBox img`).prop(`src`)?.split(/\?/)[0] ?? void 0,
                        l = e.match(/"pubDate":\s"(.*?)",/)?.[1] ?? void 0,
                        u = e.match(/"upDate":\s"(.*?)",/)?.[1] ?? void 0;
                    return (
                        (i.title = o),
                        (i.description = s),
                        (i.pubDate = l ? t(l) : i.pubDate),
                        (i.category = [
                            ...new Set([
                                ...a(`div.recipeTip a`)
                                    .toArray()
                                    .map((e) => a(e).prop(`title`)),
                                ...a(`fieldset.particulars span.category_s1`)
                                    .toArray()
                                    .map((e) => a(e).text().trim()),
                            ]),
                        ].filter(Boolean)),
                        (i.author = a(`span#recipe_username`).text()),
                        (i.content = { html: s, text: a(`div.recipDetail`).text() }),
                        (i.image = c),
                        (i.banner = c),
                        (i.updated = u ? t(u) : i.updated),
                        i
                    );
                })
            )
        );
        let y = new URL(`static/lib/logo.png`, `https://i3.meishichina.com`).href;
        return {
            title: `${l ? (g ? s : o) : `${h(`h1.on`).text()}${h(`a.right.on`).text()}`}${(
                h(`title`)
                    .text()
                    .match(/(?:.*_)?([^_]+)_(.*)$/) || []
            )
            ...
            allowEmpty: !0,
            image: y,
            author: h(`div.logo_inner a`).prop(`title`),
        };
    },
    o = {
...
| [recipe-type-do-technics-view-37](https://rsshub.app/meishichina/recipe/recipe-type-do-technics-view-37) | [recipe-type-do-technics-view-38](https://rsshub.app/meishichina/recipe/recipe-type-do-technics-view-38) | [recipe-type-do-technics-view-39](https://rsshub.app/meishichina/recipe/recipe-type-do-technics-view-39) | [recipe-type-do-technics-view-50](https://rsshub.app/meishichina/recipe/recipe-type-do-technics-view-50) |
  ...
  `,
        ...
        radar: [
            { title: `最新推荐`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/最新推荐` },
            { title: `最新发布`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/最新发布` },
            { title: `热菜`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/热菜` },
            { title: `凉菜`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/凉菜` },
            { title: `汤羹`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/汤羹` },
            { title: `主食`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/主食` },
            { title: `小吃`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/小吃` },
            { title: `西餐`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/西餐` },
            { title: `烘焙`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/烘焙` },
            { title: `自制食材`, source: [`home.meishichina.com/recipe.html`], target: `/recipe/自制食材` },
            { title: `常见菜式 - 热菜`, source: [`home.meishichina.com/recipe/recai/`], target: `/recipe/recai` },
            { title: `常见菜式 - 凉菜`, source: [`home.meishichina.com/recipe/liangcai/`], target: `/recipe/liangcai` },
            { title: `常见菜式 - 汤羹`, source: [`home.meishichina.com/recipe/tanggeng/`], target: `/recipe/tanggeng` },
            { title: `常见菜式 - 主食`, source: [`home.meishichina.com/recipe/zhushi/`], target: `/recipe/zhushi` },
            { title: `常见菜式 - 小吃`, source: [`home.meishichina.com/recipe/xiaochi/`], target: `/recipe/xiaochi` },
            { title: `常见菜式 - 家常菜`, source: [`home.meishichina.com/recipe/jiachang/`], target: `/recipe/jiachang` },
            { title: `常见菜式 - 泡酱腌菜`, source: [`home.meishichina.com/recipe/jiangpaoyancai/`], target: `/recipe/jiangpaoyancai` },
            { title: `常见菜式 - 西餐`, source: [`home.meishichina.com/recipe/xican/`], target: `/recipe/xican` },
            { title: `常见菜式 - 烘焙`, source: [`home.meishichina.com/recipe/hongbei/`], target: `/recipe/hongbei` },
            { title: `常见菜式 - 烤箱菜`, source: [`home.meishichina.com/recipe/kaoxiangcai/`], target: `/recipe/kaoxiangcai` },
            { title: `常见菜式 - 饮品`, source: [`home.meishichina.com/recipe/yinpin/`], target: `/recipe/yinpin` },
            { title: `常见菜式 - 零食`, source: [`home.meishichina.com/recipe/lingshi/`], target: `/recipe/lingshi` },
            { title: `常见菜式 - 火锅`, source: [`home.meishichina.com/recipe/huoguo/`], target: `/recipe/huoguo` },
            { title: `常见菜式 - 自制食材`, source: [`home.meishichina.com/recipe/zizhishicai/`], target: `/recipe/zizhishicai` },
            { title: `常见菜式 - 海鲜`, source: [`home.meishichina.com/recipe/haixian/`], target: `/recipe/haixian` },
            { title: `常见菜式 - 宴客菜`, source: [`home.meishichina.com/recipe/yankecai/`], target: `/recipe/yankecai` },
            { title: `主食/小吃 - 米饭`, source: [`home.meishichina.com/recipe/mifan/`], target: `/recipe/mifan` },
            { title: `主食/小吃 - 炒饭`, source: [`home.meishichina.com/recipe/chaofan/`], target: `/recipe/chaofan` },
            { title: `主食/小吃 - 面食`, source: [`home.meishichina.com/recipe/mianshi/`], target: `/recipe/mianshi` },
            { title: `主食/小吃 - 包子`, source: [`home.meishichina.com/recipe/baozi/`], target: `/recipe/baozi` },
            { title: `主食/小吃 - 饺子`, source: [`home.meishichina.com/recipe/jiaozi/`], target: `/recipe/jiaozi` },
            { title: `主食/小吃 - 馒头花卷`, source: [`home.meishichina.com/recipe/mantou/`], target: `/recipe/mantou` },
            { title: `主食/小吃 - 面条`, source: [`home.meishichina.com/recipe/miantiao/`], target: `/recipe/miantiao` },
            { title: `主食/小吃 - 饼`, source: [`home.meishichina.com/recipe/bing/`], target: `/recipe/bing` },
            { title: `主食/小吃 - 粥`, source: [`home.meishichina.com/recipe/zhou/`], target: `/recipe/zhou` },
            { title: `主食/小吃 - 馄饨`, source: [`home.meishichina.com/recipe/hundun/`], target: `/recipe/hundun` },
            { title: `主食/小吃 - 五谷杂粮`, source: [`home.meishichina.com/recipe/wuguzaliang/`], target: `/recipe/wuguzaliang` },
            { title: `主食/小吃 - 北京小吃`, source: [`home.meishichina.com/recipe/beijingxiaochi/`], target: `/recipe/beijingxiaochi` },
            { title: `主食/小吃 - 陕西小吃`, source: [`home.meishichina.com/recipe/shanxixiaochi/`], target: `/recipe/shanxixiaochi` },
            { title: `主食/小吃 - 广东小吃`, source: [`home.meishichina.com/recipe/guangdongxiaochi/`], target: `/recipe/guangdongxiaochi` },
            { title: `主食/小吃 - 四川小吃`, source: [`home.meishichina.com/recipe/sichuanxiaochi/`], target: `/recipe/sichuanxiaochi` },
            { title: `主食/小吃 - 重庆小吃`, source: [`home.meishichina.com/recipe/chongqingxiaochi/`], target: `/recipe/chongqingxiaochi` },
            { title: `主食/小吃 - 天津小吃`, source: [`home.meishichina.com/recipe/tianjinxiaochi/`], target: `/recipe/tianjinxiaochi` },
            { title: `主食/小吃 - 上海小吃`, source: [`home.meishichina.com/recipe/shanghaixiochi/`], target: `/recipe/shanghaixiochi` },
            { title: `主食/小吃 - 福建小吃`, source: [`home.meishichina.com/recipe/fujianxiaochi/`], target: `/recipe/fujianxiaochi` },
            { title: `主食/小吃 - 湖南小吃`, source: [`home.meishichina.com/recipe/hunanxiaochi/`], target: `/recipe/hunanxiaochi` },
            { title: `主食/小吃 - 湖北小吃`, source: [`home.meishichina.com/recipe/hubeixiaochi/`], target: `/recipe/hubeixiaochi` },
            { title: `主食/小吃 - 江西小吃`, source: [`home.meishichina.com/recipe/jiangxixiaochi/`], target: `/recipe/jiangxixiaochi` },
            { title: `主食/小吃 - 山东小吃`, source: [`home.meishichina.com/recipe/shandongxiaochi/`], target: `/recipe/shandongxiaochi` },
            { title: `主食/小吃 - 山西小吃`, source: [`home.meishichina.com/recipe/jinxiaochi/`], target: `/recipe/jinxiaochi` },
            { title: `主食/小吃 - 河南小吃`, source: [`home.meishichina.com/recipe/henanxiaochi/`], target: `/recipe/henanxiaochi` },
            { title: `主食/小吃 - 台湾小吃`, source: [`home.meishichina.com/recipe/taiwanxiaochi/`], target: `/recipe/taiwanxiaochi` },
            { title: `主食/小吃 - 江浙小吃`, source: [`home.meishichina.com/recipe/jiangzhexiaochi/`], target: `/recipe/jiangzhexiaochi` },
            { title: `主食/小吃 - 云贵小吃`, source: [`home.meishichina.com/recipe/yunguixiaochi/`], target: `/recipe/yunguixiaochi` },
            { title: `主食/小吃 - 东北小吃`, source: [`home.meishichina.com/recipe/dongbeixiaochi/`], target: `/recipe/dongbeixiaochi` },
            { title: `主食/小吃 - 西北小吃`, source: [`home.meishichina.com/recipe/xibeixiaochi/`], target: `/recipe/xibeixiaochi` },
            { title: `甜品/饮品 - 甜品`, source: [`home.meishichina.com/recipe/tianpin/`], target: `/recipe/tianpin` },
            { title: `甜品/饮品 - 冰品`, source: [`home.meishichina.com/recipe/bingpin/`], target: `/recipe/bingpin` },
            { title: `甜品/饮品 - 果汁`, source: [`home.meishichina.com/recipe/guozhi/`], target: `/recipe/guozhi` },
            { title: `甜品/饮品 - 糖水`, source: [`home.meishichina.com/recipe/tangshui/`], target: `/recipe/tangshui` },
            { title: `甜品/饮品 - 布丁`, source: [`home.meishichina.com/recipe/buding/`], target: `/recipe/buding` },
            { title: `甜品/饮品 - 果酱`, source: [`home.meishichina.com/recipe/guojiang/`], target: `/recipe/guojiang` },
            { title: `甜品/饮品 - 果冻`, source: [`home.meishichina.com/recipe/guodong/`], target: `/recipe/guodong` },
            { title: `甜品/饮品 - 酸奶`, source: [`home.meishichina.com/recipe/suannai/`], target: `/recipe/suannai` },
            { title: `甜品/饮品 - 鸡尾酒`, source: [`home.meishichina.com/recipe/jiweijiu/`], target: `/recipe/jiweijiu` },
            { title: `甜品/饮品 - 咖啡`, source: [`home.meishichina.com/recipe/kafei/`], target: `/recipe/kafei` },
            { title: `甜品/饮品 - 豆浆`, source: [`home.meishichina.com/recipe/doujiang/`], target: `/recipe/doujiang` },
            { title: `甜品/饮品 - 奶昔`, source: [`home.meishichina.com/recipe/naixi/`], target: `/recipe/naixi` },
            { title: `甜品/饮品 - 冰淇淋`, source: [`home.meishichina.com/recipe/bingqilin/`], target: `/recipe/bingqilin` },
            { title: `适宜人群 - 孕妇`, source: [`home.meishichina.com/recipe/yunfu/`], target: `/recipe/yunfu` },
            { title: `适宜人群 - 产妇`, source: [`home.meishichina.com/recipe/chanfu/`], target: `/recipe/chanfu` },
            { title: `适宜人群 - 婴儿`, source: [`home.meishichina.com/recipe/yinger/`], target: `/recipe/yinger` },
            { title: `适宜人群 - 儿童`, source: [`home.meishichina.com/recipe/ertong/`], target: `/recipe/ertong` },
            { title: `适宜人群 - 老人`, source: [`home.meishichina.com/recipe/laoren/`], target: `/recipe/laoren` },
            { title: `适宜人群 - 幼儿`, source: [`home.meishichina.com/recipe/youer/`], target: `/recipe/youer` },
            { title: `适宜人群 - 哺乳期`, source: [`home.meishichina.com/recipe/buruqi/`], target: `/recipe/buruqi` },
            { title: `适宜人群 - 青少年`, source: [`home.meishichina.com/recipe/qingshaonian/`], target: `/recipe/qingshaonian` },
            { title: `食疗食补 - 健康食谱`, source: [`home.meishichina.com/recipe/jiankangshipu/`], target: `/recipe/jiankangshipu` },
            { title: `食疗食补 - 减肥瘦身`, source: [`home.meishichina.com/recipe/shoushen/`], target: `/recipe/shoushen` },
            { title: `食疗食补 - 贫血`, source: [`home.meishichina.com/recipe/pinxue/`], target: `/recipe/pinxue` },
            { title: `食疗食补 - 痛经`, source: [`home.meishichina.com/recipe/tongjing/`], target: `/recipe/tongjing` },
            { title: `食疗食补 - 清热祛火`, source: [`home.meishichina.com/recipe/qingrequhuo/`], target: `/recipe/qingrequhuo` },
            { title: `食疗食补 - 滋阴`, source: [`home.meishichina.com/recipe/ziyin/`], target: `/recipe/ziyin` },
            { title: `食疗食补 - 壮阳`, source: [`home.meishichina.com/recipe/zhuangyang/`], target: `/recipe/zhuangyang` },
            { title: `食疗食补 - 便秘`, source: [`home.meishichina.com/recipe/bianmi/`], target: `/recipe/bianmi` },
            { title: `食疗食补 - 排毒养颜`, source: [`home.meishichina.com/recipe/paiduyangyan/`], target: `/recipe/paiduyangyan` },
            { title: `食疗食补 - 滋润补水`, source: [`home.meishichina.com/recipe/ziyinbushuui/`], target: `/recipe/ziyinbushuui` },
            { title: `食疗食补 - 健脾养胃`, source: [`home.meishichina.com/recipe/jianbiyangwei/`], target: `/recipe/jianbiyangwei` },
            { title: `食疗食补 - 护肝明目`, source: [`home.meishichina.com/recipe/huganmingmu/`], target: `/recipe/huganmingmu` },
            { title: `食疗食补 - 清肺止咳`, source: [`home.meishichina.com/recipe/qingfeizhike/`], target: `/recipe/qingfeizhike` },
            { title: `食疗食补 - 下奶`, source: [`home.meishichina.com/recipe/xianai/`], target: `/recipe/xianai` },
            { title: `食疗食补 - 补钙`, source: [`home.meishichina.com/recipe/bugai/`], target: `/recipe/bugai` },
            { title: `食疗食补 - 醒酒`, source: [`home.meishichina.com/recipe/xingjiu/`], target: `/recipe/xingjiu` },
            { title: `食疗食补 - 抗过敏`, source: [`home.meishichina.com/recipe/kangguomin/`], target: `/recipe/kangguomin` },
            { title: `食疗食补 - 防辐射`, source: [`home.meishichina.com/recipe/fangfushe/`], target: `/recipe/fangfushe` },
            { title: `食疗食补 - 提高免疫力`, source: [`home.meishichina.com/recipe/tigaomianyili/`], target: `/recipe/tigaomianyili` },
            { title: `食疗食补 - 流感`, source: [`home.meishichina.com/recipe/liugan/`], target: `/recipe/liugan` },
            { title: `食疗食补 - 驱寒暖身`, source: [`home.meishichina.com/recipe/quhannuanshen/`], target: `/recipe/quhannuanshen` },
            { title: `食疗食补 - 秋冬进补`, source: [`home.meishichina.com/recipe/qiudongjinbu/`], target: `/recipe/qiudongjinbu` },
            { title: `食疗食补 - 消暑解渴`, source: [`home.meishichina.com/recipe/xiaoshujieke/`], target: `/recipe/xiaoshujieke` },
            { title: `场景 - 早餐`, source: [`home.meishichina.com/recipe/zaocan/`], target: `/recipe/zaocan` },
            { title: `场景 - 下午茶`, source: [`home.meishichina.com/recipe/xiawucha/`], target: `/recipe/xiawucha` },
            { title: `场景 - 二人世界`, source: [`home.meishichina.com/recipe/erren/`], target: `/recipe/erren` },
            { title: `场景 - 野餐`, source: [`home.meishichina.com/recipe/yecan/`], target: `/recipe/yecan` },
            { title: `场景 - 开胃菜`, source: [`home.meishichina.com/recipe/kaiweicai/`], target: `/recipe/kaiweicai` },
            { title: `场景 - 私房菜`, source: [`home.meishichina.com/recipe/sifangcai/`], target: `/recipe/sifangcai` },
            { title: `场景 - 快餐`, source: [`home.meishichina.com/recipe/kuaican/`], target: `/recipe/kuaican` },
            { title: `场景 - 快手菜`, source: [`home.meishichina.com/recipe/kuaishoucai/`], target: `/recipe/kuaishoucai` },
            { title: `场景 - 宿舍时代`, source: [`home.meishichina.com/recipe/susheshidai/`], target: `/recipe/susheshidai` },
            { title: `场景 - 中式宴请`, source: [`home.meishichina.com/recipe/zhongshiyanqing/`], target: `/recipe/zhongshiyanqing` },
            { title: `场景 - 西式宴请`, source: [`home.meishichina.com/recipe/xishiyanqing/`], target: `/recipe/xishiyanqing` },
            { title: `饮食方式 - 素食`, source: [`home.meishichina.com/recipe/sushi/`], target: `/recipe/sushi` },
            { title: `饮食方式 - 素菜`, source: [`home.meishichina.com/recipe/sucai2/`], target: `/recipe/sucai2` },
            { title: `饮食方式 - 清真菜`, source: [`home.meishichina.com/recipe/qingzhencai/`], target: `/recipe/qingzhencai` },
            { title: `饮食方式 - 春季食谱`, source: [`home.meishichina.com/recipe/chunji/`], target: `/recipe/chunji` },
            { title: `饮食方式 - 夏季食谱`, source: [`home.meishichina.com/recipe/xiaji/`], target: `/recipe/xiaji` },
            { title: `饮食方式 - 秋季食谱`, source: [`home.meishichina.com/recipe/qiuji/`], target: `/recipe/qiuji` },
            { title: `饮食方式 - 冬季食谱`, source: [`home.meishichina.com/recipe/dongji/`], target: `/recipe/dongji` },
            { title: `饮食方式 - 小清新`, source: [`home.meishichina.com/recipe/xiaoqingxin/`], target: `/recipe/xiaoqingxin` },
            { title: `饮食方式 - 高颜值`, source: [`home.meishichina.com/recipe/gaoyanzhi/`], target: `/recipe/gaoyanzhi` },
            { title: `中式菜系 - 川菜`, source: [`home.meishichina.com/recipe/chuancai/`], target: `/recipe/chuancai` },
            { title: `中式菜系 - 鲁菜`, source: [`home.meishichina.com/recipe/lucai/`], target: `/recipe/lucai` },
            { title: `中式菜系 - 闽菜`, source: [`home.meishichina.com/recipe/mincai/`], target: `/recipe/mincai` },
            { title: `中式菜系 - 粤菜`, source: [`home.meishichina.com/recipe/yuecai/`], target: `/recipe/yuecai` },
            { title: `中式菜系 - 苏菜`, source: [`home.meishichina.com/recipe/sucai/`], target: `/recipe/sucai` },
            { title: `中式菜系 - 浙菜`, source: [`home.meishichina.com/recipe/zhecai/`], target: `/recipe/zhecai` },
            { title: `中式菜系 - 湘菜`, source: [`home.meishichina.com/recipe/xiangcai/`], target: `/recipe/xiangcai` },
            { title: `中式菜系 - 徽菜`, source: [`home.meishichina.com/recipe/huicai/`], target: `/recipe/huicai` },
            { title: `中式菜系 - 淮扬菜`, source: [`home.meishichina.com/recipe/huaiyangcai/`], target: `/recipe/huaiyangcai` },
            { title: `中式菜系 - 豫菜`, source: [`home.meishichina.com/recipe/yucai/`], target: `/recipe/yucai` },
            { title: `中式菜系 - 晋菜`, source: [`home.meishichina.com/recipe/jincai/`], target: `/recipe/jincai` },
            { title: `中式菜系 - 鄂菜`, source: [`home.meishichina.com/recipe/ecai/`], target: `/recipe/ecai` },
            { title: `中式菜系 - 云南菜`, source: [`home.meishichina.com/recipe/yunnancai/`], target: `/recipe/yunnancai` },
            { title: `中式菜系 - 北京菜`, source: [`home.meishichina.com/recipe/beijingcai/`], target: `/recipe/beijingcai` },
            { title: `中式菜系 - 东北菜`, source: [`home.meishichina.com/recipe/dongbeicai/`], target: `/recipe/dongbeicai` },
            { title: `中式菜系 - 西北菜`, source: [`home.meishichina.com/recipe/xibeicai/`], target: `/recipe/xibeicai` },
            { title: `中式菜系 - 贵州菜`, source: [`home.meishichina.com/recipe/guizhoucai/`], target: `/recipe/guizhoucai` },
            { title: `中式菜系 - 上海菜`, source: [`home.meishichina.com/recipe/shanghaicai/`], target: `/recipe/shanghaicai` },
            { title: `中式菜系 - 新疆菜`, source: [`home.meishichina.com/recipe/xinjiangcai/`], target: `/recipe/xinjiangcai` },
            { title: `中式菜系 - 客家菜`, source: [`home.meishichina.com/recipe/kejiacai/`], target: `/recipe/kejiacai` },
            { title: `中式菜系 - 台湾美食`, source: [`home.meishichina.com/recipe/taiwancai/`], target: `/recipe/taiwancai` },
            { title: `中式菜系 - 香港美食`, source: [`home.meishichina.com/recipe/xianggangcai/`], target: `/recipe/xianggangcai` },
            { title: `中式菜系 - 澳门美食`, source: [`home.meishichina.com/recipe/aomeicai/`], target: `/recipe/aomeicai` },
            { title: `中式菜系 - 赣菜`, source: [`home.meishichina.com/recipe/gancai/`], target: `/recipe/gancai` },
            { title: `中式菜系 - 中式菜系`, source: [`home.meishichina.com/recipe/zhongshicaixi/`], target: `/recipe/zhongshicaixi` },
            { title: `外国美食 - 日本料理`, source: [`home.meishichina.com/recipe/ribencai/`], target: `/recipe/ribencai` },
            { title: `外国美食 - 韩国料理`, source: [`home.meishichina.com/recipe/hanguocai/`], target: `/recipe/hanguocai` },
            { title: `外国美食 - 泰国菜`, source: [`home.meishichina.com/recipe/taiguocai/`], target: `/recipe/taiguocai` },
            { title: `外国美食 - 印度菜`, source: [`home.meishichina.com/recipe/yiducai/`], target: `/recipe/yiducai` },
            { title: `外国美食 - 法国菜`, source: [`home.meishichina.com/recipe/faguocai/`], target: `/recipe/faguocai` },
            { title: `外国美食 - 意大利菜`, source: [`home.meishichina.com/recipe/yidalicai/`], target: `/recipe/yidalicai` },
            { title: `外国美食 - 西班牙菜`, source: [`home.meishichina.com/recipe/xibanya/`], target: `/recipe/xibanya` },
            { title: `外国美食 - 英国菜`, source: [`home.meishichina.com/recipe/yingguocai/`], target: `/recipe/yingguocai` },
            { title: `外国美食 - 越南菜`, source: [`home.meishichina.com/recipe/yuenancai/`], target: `/recipe/yuenancai` },
            { title: `外国美食 - 墨西哥菜`, source: [`home.meishichina.com/recipe/moxigecai/`], target: `/recipe/moxigecai` },
            { title: `外国美食 - 外国美食`, source: [`home.meishichina.com/recipe/waiguomeishi/`], target: `/recipe/waiguomeishi` },
            { title: `烘焙 - 蛋糕`, source: [`home.meishichina.com/recipe/dangao/`], target: `/recipe/dangao` },
            { title: `烘焙 - 面包`, source: [`home.meishichina.com/recipe/mianbao/`], target: `/recipe/mianbao` },
            { title: `烘焙 - 饼干`, source: [`home.meishichina.com/recipe/binggan/`], target: `/recipe/binggan` },
            { title: `烘焙 - 派塔`, source: [`home.meishichina.com/recipe/paita/`], target: `/recipe/paita` },
            { title: `烘焙 - 吐司`, source: [`home.meishichina.com/recipe/tusi/`], target: `/recipe/tusi` },
            { title: `烘焙 - 戚风蛋糕`, source: [`home.meishichina.com/recipe/qifeng/`], target: `/recipe/qifeng` },
            { title: `烘焙 - 纸杯蛋糕`, source: [`home.meishichina.com/recipe/zhibei/`], target: `/recipe/zhibei` },
            { title: `烘焙 - 蛋糕卷`, source: [`home.meishichina.com/recipe/dangaojuan/`], target: `/recipe/dangaojuan` },
            { title: `烘焙 - 玛芬蛋糕`, source: [`home.meishichina.com/recipe/mafen/`], target: `/recipe/mafen` },
            { title: `烘焙 - 乳酪蛋糕`, source: [`home.meishichina.com/recipe/rulao/`], target: `/recipe/rulao` },
            { title: `烘焙 - 芝士蛋糕`, source: [`home.meishichina.com/recipe/zhishi/`], target: `/recipe/zhishi` },
            { title: `烘焙 - 奶油蛋糕`, source: [`home.meishichina.com/recipe/naiyou/`], target: `/recipe/naiyou` },
            { title: `烘焙 - 批萨`, source: [`home.meishichina.com/recipe/pisa/`], target: `/recipe/pisa` },
            { title: `烘焙 - 慕斯`, source: [`home.meishichina.com/recipe/musi/`], target: `/recipe/musi` },
            { title: `烘焙 - 曲奇`, source: [`home.meishichina.com/recipe/quqi/`], target: `/recipe/quqi` },
            { title: `烘焙 - 翻糖`, source: [`home.meishichina.com/recipe/fantang/`], target: `/recipe/fantang` },
            { title: `传统美食 - 粽子`, source: [`home.meishichina.com/recipe/zongzi/`], target: `/recipe/zongzi` },
            { title: `传统美食 - 月饼`, source: [`home.meishichina.com/recipe/yuebing/`], target: `/recipe/yuebing` },
            { title: `传统美食 - 春饼`, source: [`home.meishichina.com/recipe/chunbing/`], target: `/recipe/chunbing` },
            { title: `传统美食 - 元宵`, source: [`home.meishichina.com/recipe/yuanxiao/`], target: `/recipe/yuanxiao` },
            { title: `传统美食 - 汤圆`, source: [`home.meishichina.com/recipe/tangyuan/`], target: `/recipe/tangyuan` },
            { title: `传统美食 - 青团`, source: [`home.meishichina.com/recipe/qingtuan/`], target: `/recipe/qingtuan` },
            { title: `传统美食 - 腊八粥`, source: [`home.meishichina.com/recipe/labazhou/`], target: `/recipe/labazhou` },
            { title: `传统美食 - 春卷`, source: [`home.meishichina.com/recipe/chunjuan/`], target: `/recipe/chunjuan` },
            { title: `传统美食 - 传统美食`, source: [`home.meishichina.com/recipe/chuantongmeishi/`], target: `/recipe/chuantongmeishi` },
            { title: `节日食俗 - 立冬`, source: [`home.meishichina.com/recipe/lidong/`], target: `/recipe/lidong` },
            { title: `节日食俗 - 冬至`, source: [`home.meishichina.com/recipe/dongzhi/`], target: `/recipe/dongzhi` },
            { title: `节日食俗 - 腊八`, source: [`home.meishichina.com/recipe/laba/`], target: `/recipe/laba` },
            { title: `节日食俗 - 端午节`, source: [`home.meishichina.com/recipe/duanwu/`], target: `/recipe/duanwu` },
            { title: `节日食俗 - 中秋`, source: [`home.meishichina.com/recipe/zhongqiu/`], target: `/recipe/zhongqiu` },
            { title: `节日食俗 - 立春`, source: [`home.meishichina.com/recipe/lichun/`], target: `/recipe/lichun` },
            { title: `节日食俗 - 元宵节`, source: [`home.meishichina.com/recipe/yuanxiaojie/`], target: `/recipe/yuanxiaojie` },
            { title: `节日食俗 - 贴秋膘`, source: [`home.meishichina.com/recipe/tieqiubiao/`], target: `/recipe/tieqiubiao` },
            { title: `节日食俗 - 清明`, source: [`home.meishichina.com/recipe/qingming/`], target: `/recipe/qingming` },
            { title: `节日食俗 - 年夜饭`, source: [`home.meishichina.com/recipe/nianyefan/`], target: `/recipe/nianyefan` },
            { title: `节日食俗 - 圣诞节`, source: [`home.meishichina.com/recipe/shengdanjie/`], target: `/recipe/shengdanjie` },
            { title: `节日食俗 - 感恩节`, source: [`home.meishichina.com/recipe/ganenjie/`], target: `/recipe/ganenjie` },
            { title: `节日食俗 - 万圣节`, source: [`home.meishichina.com/recipe/wanshengjie/`], target: `/recipe/wanshengjie` },
            { title: `节日食俗 - 情人节`, source: [`home.meishichina.com/recipe/qingrenjie/`], target: `/recipe/qingrenjie` },
            { title: `节日食俗 - 复活节`, source: [`home.meishichina.com/recipe/fuhuojie/`], target: `/recipe/fuhuojie` },
            { title: `节日食俗 - 雨水`, source: [`home.meishichina.com/recipe/yushui/`], target: `/recipe/yushui` },
            { title: `节日食俗 - 惊蛰`, source: [`home.meishichina.com/recipe/jingzhi/`], target: `/recipe/jingzhi` },
            { title: `节日食俗 - 春分`, source: [`home.meishichina.com/recipe/chunfen/`], target: `/recipe/chunfen` },
            { title: `节日食俗 - 谷雨`, source: [`home.meishichina.com/recipe/guyu/`], target: `/recipe/guyu` },
            { title: `节日食俗 - 立夏`, source: [`home.meishichina.com/recipe/lixia/`], target: `/recipe/lixia` },
            { title: `节日食俗 - 小满`, source: [`home.meishichina.com/recipe/xiaoman/`], target: `/recipe/xiaoman` },
            { title: `节日食俗 - 芒种`, source: [`home.meishichina.com/recipe/mangzhong/`], target: `/recipe/mangzhong` },
            { title: `节日食俗 - 夏至`, source: [`home.meishichina.com/recipe/xiazhi/`], target: `/recipe/xiazhi` },
            { title: `节日食俗 - 小暑`, source: [`home.meishichina.com/recipe/xiaoshu/`], target: `/recipe/xiaoshu` },
            { title: `节日食俗 - 大暑`, source: [`home.meishichina.com/recipe/dashu/`], target: `/recipe/dashu` },
            { title: `节日食俗 - 立秋`, source: [`home.meishichina.com/recipe/xiqiu/`], target: `/recipe/xiqiu` },
            { title: `节日食俗 - 处暑`, source: [`home.meishichina.com/recipe/chushu/`], target: `/recipe/chushu` },
            { title: `节日食俗 - 白露`, source: [`home.meishichina.com/recipe/bailu/`], target: `/recipe/bailu` },
            { title: `节日食俗 - 秋分`, source: [`home.meishichina.com/recipe/qiufen/`], target: `/recipe/qiufen` },
            { title: `节日食俗 - 寒露`, source: [`home.meishichina.com/recipe/hanlu/`], target: `/recipe/hanlu` },
            { title: `节日食俗 - 霜降`, source: [`home.meishichina.com/recipe/shuangjiang/`], target: `/recipe/shuangjiang` },
            { title: `节日食俗 - 小雪`, source: [`home.meishichina.com/recipe/xiaoxue/`], target: `/recipe/xiaoxue` },
            { title: `节日食俗 - 大雪`, source: [`home.meishichina.com/recipe/daxue/`], target: `/recipe/daxue` },
            { title: `节日食俗 - 小寒`, source: [`home.meishichina.com/recipe/xiaohan/`], target: `/recipe/xiaohan` },
            { title: `节日食俗 - 大寒`, source: [`home.meishichina.com/recipe/dahan/`], target: `/recipe/dahan` },
            { title: `节日食俗 - 二月二`, source: [`home.meishichina.com/recipe/eryueer/`], target: `/recipe/eryueer` },
            { title: `节日食俗 - 母亲节`, source: [`home.meishichina.com/recipe/muqinjie/`], target: `/recipe/muqinjie` },
            { title: `节日食俗 - 父亲节`, source: [`home.meishichina.com/recipe/fuqinjie/`], target: `/recipe/fuqinjie` },
            { title: `节日食俗 - 儿童节`, source: [`home.meishichina.com/recipe/ertongjie/`], target: `/recipe/ertongjie` },
            { title: `节日食俗 - 七夕`, source: [`home.meishichina.com/recipe/qixi/`], target: `/recipe/qixi` },
            { title: `节日食俗 - 重阳节`, source: [`home.meishichina.com/recipe/chongyangjie/`], target: `/recipe/chongyangjie` },
            { title: `节日食俗 - 节日习俗`, source: [`home.meishichina.com/recipe/jierixisu/`], target: `/recipe/jierixisu` },
            { title: `按制作难度 - 简单`, source: [`home.meishichina.com/recipe-type-do-level-view-1.html`], target: `/recipe/recipe-type-do-level-view-1` },
            { title: `按制作难度 - 普通`, source: [`home.meishichina.com/recipe-type-do-level-view-2.html`], target: `/recipe/recipe-type-do-level-view-2` },
            { title: `按制作难度 - 高级`, source: [`home.meishichina.com/recipe-type-do-level-view-3.html`], target: `/recipe/recipe-type-do-level-view-3` },
            { title: `按制作难度 - 神级`, source: [`home.meishichina.com/recipe-type-do-level-view-4.html`], target: `/recipe/recipe-type-do-level-view-4` },
            { title: `按所需时间 - 十分钟`, source: [`home.meishichina.com/recipe-type-do-during-view-1.html`], target: `/recipe/recipe-type-do-during-view-1` },
            { title: `按所需时间 - 廿分钟`, source: [`home.meishichina.com/recipe-type-do-during-view-2.html`], target: `/recipe/recipe-type-do-during-view-2` },
            { title: `按所需时间 - 半小时`, source: [`home.meishichina.com/recipe-type-do-during-view-3.html`], target: `/recipe/recipe-type-do-during-view-3` },
            { title: `按所需时间 - 三刻钟`, source: [`home.meishichina.com/recipe-type-do-during-view-4.html`], target: `/recipe/recipe-type-do-during-view-4` },
            { title: `按所需时间 - 一小时`, source: [`home.meishichina.com/recipe-type-do-during-view-5.html`], target: `/recipe/recipe-type-do-during-view-5` },
            { title: `按所需时间 - 数小时`, source: [`home.meishichina.com/recipe-type-do-during-view-6.html`], target: `/recipe/recipe-type-do-during-view-6` },
            { title: `按所需时间 - 一天`, source: [`home.meishichina.com/recipe-type-do-during-view-7.html`], target: `/recipe/recipe-type-do-during-view-7` },
            { title: `按所需时间 - 数天`, source: [`home.meishichina.com/recipe-type-do-during-view-8.html`], target: `/recipe/recipe-type-do-during-view-8` },
            { title: `按菜品口味 - 微辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-1.html`], target: `/recipe/recipe-type-do-cuisine-view-1` },
            { title: `按菜品口味 - 中辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-2.html`], target: `/recipe/recipe-type-do-cuisine-view-2` },
            { title: `按菜品口味 - 超辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-3.html`], target: `/recipe/recipe-type-do-cuisine-view-3` },
            { title: `按菜品口味 - 麻辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-4.html`], target: `/recipe/recipe-type-do-cuisine-view-4` },
            { title: `按菜品口味 - 酸辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-5.html`], target: `/recipe/recipe-type-do-cuisine-view-5` },
            { title: `按菜品口味 - 甜辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-29.html`], target: `/recipe/recipe-type-do-cuisine-view-29` },
            { title: `按菜品口味 - 香辣`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-31.html`], target: `/recipe/recipe-type-do-cuisine-view-31` },
            { title: `按菜品口味 - 酸甜`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-6.html`], target: `/recipe/recipe-type-do-cuisine-view-6` },
            { title: `按菜品口味 - 酸咸`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-7.html`], target: `/recipe/recipe-type-do-cuisine-view-7` },
            { title: `按菜品口味 - 咸鲜`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-8.html`], target: `/recipe/recipe-type-do-cuisine-view-8` },
            { title: `按菜品口味 - 咸甜`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-9.html`], target: `/recipe/recipe-type-do-cuisine-view-9` },
            { title: `按菜品口味 - 甜味`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-10.html`], target: `/recipe/recipe-type-do-cuisine-view-10` },
            { title: `按菜品口味 - 苦味`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-11.html`], target: `/recipe/recipe-type-do-cuisine-view-11` },
            { title: `按菜品口味 - 原味`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-12.html`], target: `/recipe/recipe-type-do-cuisine-view-12` },
            { title: `按菜品口味 - 清淡`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-13.html`], target: `/recipe/recipe-type-do-cuisine-view-13` },
            { title: `按菜品口味 - 五香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-14.html`], target: `/recipe/recipe-type-do-cuisine-view-14` },
            { title: `按菜品口味 - 鱼香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-15.html`], target: `/recipe/recipe-type-do-cuisine-view-15` },
            { title: `按菜品口味 - 葱香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-16.html`], target: `/recipe/recipe-type-do-cuisine-view-16` },
            { title: `按菜品口味 - 蒜香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-17.html`], target: `/recipe/recipe-type-do-cuisine-view-17` },
            { title: `按菜品口味 - 奶香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-18.html`], target: `/recipe/recipe-type-do-cuisine-view-18` },
            { title: `按菜品口味 - 酱香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-19.html`], target: `/recipe/recipe-type-do-cuisine-view-19` },
            { title: `按菜品口味 - 糟香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-20.html`], target: `/recipe/recipe-type-do-cuisine-view-20` },
            { title: `按菜品口味 - 咖喱`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-21.html`], target: `/recipe/recipe-type-do-cuisine-view-21` },
            { title: `按菜品口味 - 孜然`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-22.html`], target: `/recipe/recipe-type-do-cuisine-view-22` },
            { title: `按菜品口味 - 果味`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-23.html`], target: `/recipe/recipe-type-do-cuisine-view-23` },
            { title: `按菜品口味 - 香草`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-24.html`], target: `/recipe/recipe-type-do-cuisine-view-24` },
            { title: `按菜品口味 - 怪味`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-25.html`], target: `/recipe/recipe-type-do-cuisine-view-25` },
            { title: `按菜品口味 - 咸香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-26.html`], target: `/recipe/recipe-type-do-cuisine-view-26` },
            { title: `按菜品口味 - 甜香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-27.html`], target: `/recipe/recipe-type-do-cuisine-view-27` },
            { title: `按菜品口味 - 麻香`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-28.html`], target: `/recipe/recipe-type-do-cuisine-view-28` },
            { title: `按菜品口味 - 其他`, source: [`home.meishichina.com/recipe-type-do-cuisine-view-50.html`], target: `/recipe/recipe-type-do-cuisine-view-50` },
            { title: `按主要工艺 - 烧`, source: [`home.meishichina.com/recipe-type-do-technics-view-1.html`], target: `/recipe/recipe-type-do-technics-view-1` },
            { title: `按主要工艺 - 炒`, source: [`home.meishichina.com/recipe-type-do-technics-view-2.html`], target: `/recipe/recipe-type-do-technics-view-2` },
            { title: `按主要工艺 - 爆`, source: [`home.meishichina.com/recipe-type-do-technics-view-3.html`], target: `/recipe/recipe-type-do-technics-view-3` },
            { title: `按主要工艺 - 焖`, source: [`home.meishichina.com/recipe-type-do-technics-view-4.html`], target: `/recipe/recipe-type-do-technics-view-4` },
            { title: `按主要工艺 - 炖`, source: [`home.meishichina.com/recipe-type-do-technics-view-5.html`], target: `/recipe/recipe-type-do-technics-view-5` },
            { title: `按主要工艺 - 蒸`, source: [`home.meishichina.com/recipe-type-do-technics-view-6.html`], target: `/recipe/recipe-type-do-technics-view-6` },
            { title: `按主要工艺 - 煮`, source: [`home.meishichina.com/recipe-type-do-technics-view-7.html`], target: `/recipe/recipe-type-do-technics-view-7` },
            { title: `按主要工艺 - 拌`, source: [`home.meishichina.com/recipe-type-do-technics-view-8.html`], target: `/recipe/recipe-type-do-technics-view-8` },
            { title: `按主要工艺 - 烤`, source: [`home.meishichina.com/recipe-type-do-technics-view-9.html`], target: `/recipe/recipe-type-do-technics-view-9` },
            { title: `按主要工艺 - 炸`, source: [`home.meishichina.com/recipe-type-do-technics-view-10.html`], target: `/recipe/recipe-type-do-technics-view-10` },
            { title: `按主要工艺 - 烩`, source: [`home.meishichina.com/recipe-type-do-technics-view-11.html`], target: `/recipe/recipe-type-do-technics-view-11` },
            { title: `按主要工艺 - 溜`, source: [`home.meishichina.com/recipe-type-do-technics-view-12.html`], target: `/recipe/recipe-type-do-technics-view-12` },
            { title: `按主要工艺 - 氽`, source: [`home.meishichina.com/recipe-type-do-technics-view-13.html`], target: `/recipe/recipe-type-do-technics-view-13` },
            { title: `按主要工艺 - 腌`, source: [`home.meishichina.com/recipe-type-do-technics-view-14.html`], target: `/recipe/recipe-type-do-technics-view-14` },
            { title: `按主要工艺 - 卤`, source: [`home.meishichina.com/recipe-type-do-technics-view-15.html`], target: `/recipe/recipe-type-do-technics-view-15` },
            { title: `按主要工艺 - 炝`, source: [`home.meishichina.com/recipe-type-do-technics-view-16.html`], target: `/recipe/recipe-type-do-technics-view-16` },
            { title: `按主要工艺 - 煎`, source: [`home.meishichina.com/recipe-type-do-technics-view-17.html`], target: `/recipe/recipe-type-do-technics-view-17` },
            { title: `按主要工艺 - 酥`, source: [`home.meishichina.com/recipe-type-do-technics-view-18.html`], target: `/recipe/recipe-type-do-technics-view-18` },
            { title: `按主要工艺 - 扒`, source: [`home.meishichina.com/recipe-type-do-technics-view-19.html`], target: `/recipe/recipe-type-do-technics-view-19` },
            { title: `按主要工艺 - 熏`, source: [`home.meishichina.com/recipe-type-do-technics-view-20.html`], target: `/recipe/recipe-type-do-technics-view-20` },
            { title: `按主要工艺 - 煨`, source: [`home.meishichina.com/recipe-type-do-technics-view-21.html`], target: `/recipe/recipe-type-do-technics-view-21` },
            { title: `按主要工艺 - 酱`, source: [`home.meishichina.com/recipe-type-do-technics-view-22.html`], target: `/recipe/recipe-type-do-technics-view-22` },
            { title: `按主要工艺 - 煲`, source: [`home.meishichina.com/recipe-type-do-technics-view-30.html`], target: `/recipe/recipe-type-do-technics-view-30` },
            { title: `按主要工艺 - 烘焙`, source: [`home.meishichina.com/recipe-type-do-technics-view-23.html`], target: `/recipe/recipe-type-do-technics-view-23` },
            { title: `按主要工艺 - 火锅`, source: [`home.meishichina.com/recipe-type-do-technics-view-24.html`], target: `/recipe/recipe-type-do-technics-view-24` },
            { title: `按主要工艺 - 砂锅`, source: [`home.meishichina.com/recipe-type-do-technics-view-25.html`], target: `/recipe/recipe-type-do-technics-view-25` },
            { title: `按主要工艺 - 拔丝`, source: [`home.meishichina.com/recipe-type-do-technics-view-26.html`], target: `/recipe/recipe-type-do-technics-view-26` },
            { title: `按主要工艺 - 生鲜`, source: [`home.meishichina.com/recipe-type-do-technics-view-27.html`], target: `/recipe/recipe-type-do-technics-view-27` },
            { title: `按主要工艺 - 调味`, source: [`home.meishichina.com/recipe-type-do-technics-view-28.html`], target: `/recipe/recipe-type-do-technics-view-28` },
            { title: `按主要工艺 - 技巧`, source: [`home.meishichina.com/recipe-type-do-technics-view-29.html`], target: `/recipe/recipe-type-do-technics-view-29` },
            { title: `按主要工艺 - 烙`, source: [`home.meishichina.com/recipe-type-do-technics-view-31.html`], target: `/recipe/recipe-type-do-technics-view-31` },
            { title: `按主要工艺 - 榨汁`, source: [`home.meishichina.com/recipe-type-do-technics-view-32.html`], target: `/recipe/recipe-type-do-technics-view-32` },
            { title: `按主要工艺 - 冷冻`, source: [`home.meishichina.com/recipe-type-do-technics-view-33.html`], target: `/recipe/recipe-type-do-technics-view-33` },
            { title: `按主要工艺 - 焗`, source: [`home.meishichina.com/recipe-type-do-technics-view-34.html`], target: `/recipe/recipe-type-do-technics-view-34` },
            { title: `按主要工艺 - 焯`, source: [`home.meishichina.com/recipe-type-do-technics-view-35.html`], target: `/recipe/recipe-type-do-technics-view-35` },
            { title: `按主要工艺 - 干煸`, source: [`home.meishichina.com/recipe-type-do-technics-view-36.html`], target: `/recipe/recipe-type-do-technics-view-36` },
            { title: `按主要工艺 - 干锅`, source: [`home.meishichina.com/recipe-type-do-technics-view-37.html`], target: `/recipe/recipe-type-do-technics-view-37` },
            { title: `按主要工艺 - 铁板`, source: [`home.meishichina.com/recipe-type-do-technics-view-38.html`], target: `/recipe/recipe-type-do-technics-view-38` },
            { title: `按主要工艺 - 微波`, source: [`home.meishichina.com/recipe-type-do-technics-view-39.html`], target: `/recipe/recipe-type-do-technics-view-39` },
            { title: `按主要工艺 - 其他`, source: [`home.meishichina.com/recipe-type-do-technics-view-50.html`], target: `/recipe/recipe-type-do-technics-view-50` },
        ],
    };
