...
const o = async (t) => {
        let { keywords: o } = t.req.param(),
            s = Number.parseInt(t.req.query(`limit`) ?? `30`, 10),
            c = new URL(`search-result/?s=${o}`, n).href,
            l = new URL(`api/articles/searchkeywords`, n).href,
            u = i((await e(l, { query: { keywords: o, current: 1, size: s } })).data.records, s);
    ...
    s = {
        ...
        radar: [{ source: [`n.ifun.cool/search-result`], target: (e, t) => `/ifun/n/search/${new URL(t).searchParams.get(`s`)}` }],
        view: t.Articles,
    };
