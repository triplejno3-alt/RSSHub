...
const a = (e) => e.split(`.`).pop(),
    o = {
        ...
        example: `/ecnu/art`,
        radar: [{ source: [`art.ecnu.edu.cn`], target: `/art` }],
        name: `美术学院通知公告`,
        maintainers: [`FrozenStarrrr`, `ChiyoYuki`, `ECNU-minus`],
        handler: async () => {
            let o = `https://art.ecnu.edu.cn/`,
                s = i((await n(`${o}tzggwzpw/list.htm`)).data),
                c = s(`ul.data-list > li`)
                    .toArray()
                    .map((e) => ({ pubDate: r(t(s(e).find(`span`).text()), 8), link: new URL(s(e).find(`a`).attr(`href`), o).toString(), title: s(e).find(`a`).text() }));
            return {
                title: `美术学院通知公告`,
