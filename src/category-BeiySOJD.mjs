...
import { t as i } from './description-JiHYizv6.mjs';
import { load as a } from 'cheerio';
const o = async (r) => {
        let { id: o } = r.req.param(),
            s = Number.parseInt(r.req.query(`limit`) ?? `50`, 10),
            c = `https://papers.cool`,
            l = new URL(`${o}?show=${s}`, c).href,
            u = a(await e(l)),
            ...
            f = u(`div.paper`)
                ...
                .map((e) => {
                    let r = u(e),
                        ...
                        s = r.find(`a.title-link`).attr(`href`),
                        f = r.find(`p.subjects a`).toArray(),
                        p = [...new Set(f.map((e) => u(e).text()).filter(Boolean))],
                        m = r
                            .find(`p.authors a.author`)
                            .toArray()
                            .map((e) => {
                                let t = u(e);
                        ...
                        g = `papers.cool-${h}`,
                        _ = o,
                        v = { title: a, pubDate: o ? n(t(o), 0) : void 0, link: s ? new URL(s, c).href : void 0, category: p, author: m, doi: h, guid: g, id: g, updated: _ ? n(t(_), 0) : void 0, language: d },
                        y = r
                            .find(`a.title-pdf`)
                            .first()
                            .attr(`onclick`)
                            ?.match(/togglePdf\('.*?',\s'(.*?)',\sthis\)/)?.[1];
                    y && (v = { ...v, enclosure_url: y, enclosure_type: `application/pdf`, enclosure_title: a, enclosure_length: void 0 });
                    let b = i({ pdfUrl: y, kimiUrl: `${l.replace(/[a-zA-Z0-9.]+$/, `kimi`)}?paper=${h}`, authors: m, summary: r.find(`p.summary`).text() });
                    return ((v = { ...v, description: b, content: { html: b, text: b } }), v);
                })
                .filter((e) => !0);
        return {
            title: u(`title`).text(),
    ...
    s = {
        ...
        parameters: { id: { description: `Category ID, can be found in URL` } },
        description: `::: tip
...
`,
        ...
        radar: [
            { source: [`papers.cool/:id{.+}`], target: `/category/:id` },
            { title: `Astrophysics (astro-ph)`, source: [`papers.cool/arxiv/astro-ph`], target: `/category/arxiv/astro-ph` },
            { title: `Astrophysics of Galaxies (astro-ph.GA)`, source: [`papers.cool/arxiv/astro-ph.GA`], target: `/category/arxiv/astro-ph.GA` },
            { title: `Cosmology and Nongalactic Astrophysics (astro-ph.CO)`, source: [`papers.cool/arxiv/astro-ph.CO`], target: `/category/arxiv/astro-ph.CO` },
            { title: `Earth and Planetary Astrophysics (astro-ph.EP)`, source: [`papers.cool/arxiv/astro-ph.EP`], target: `/category/arxiv/astro-ph.EP` },
            { title: `High Energy Astrophysical Phenomena (astro-ph.HE)`, source: [`papers.cool/arxiv/astro-ph.HE`], target: `/category/arxiv/astro-ph.HE` },
            { title: `Instrumentation and Methods for Astrophysics (astro-ph.IM)`, source: [`papers.cool/arxiv/astro-ph.IM`], target: `/category/arxiv/astro-ph.IM` },
            { title: `Solar and Stellar Astrophysics (astro-ph.SR)`, source: [`papers.cool/arxiv/astro-ph.SR`], target: `/category/arxiv/astro-ph.SR` },
            { title: `Condensed Matter (cond-mat)`, source: [`papers.cool/arxiv/cond-mat`], target: `/category/arxiv/cond-mat` },
            { title: `Disordered Systems and Neural Networks (cond-mat.dis-nn)`, source: [`papers.cool/arxiv/cond-mat.dis-nn`], target: `/category/arxiv/cond-mat.dis-nn` },
            { title: `Materials Science (cond-mat.mtrl-sci)`, source: [`papers.cool/arxiv/cond-mat.mtrl-sci`], target: `/category/arxiv/cond-mat.mtrl-sci` },
            { title: `Mesoscale and Nanoscale Physics (cond-mat.mes-hall)`, source: [`papers.cool/arxiv/cond-mat.mes-hall`], target: `/category/arxiv/cond-mat.mes-hall` },
            { title: `Other Condensed Matter (cond-mat.other)`, source: [`papers.cool/arxiv/cond-mat.other`], target: `/category/arxiv/cond-mat.other` },
            { title: `Quantum Gases (cond-mat.quant-gas)`, source: [`papers.cool/arxiv/cond-mat.quant-gas`], target: `/category/arxiv/cond-mat.quant-gas` },
            { title: `Soft Condensed Matter (cond-mat.soft)`, source: [`papers.cool/arxiv/cond-mat.soft`], target: `/category/arxiv/cond-mat.soft` },
            { title: `Statistical Mechanics (cond-mat.stat-mech)`, source: [`papers.cool/arxiv/cond-mat.stat-mech`], target: `/category/arxiv/cond-mat.stat-mech` },
            { title: `Strongly Correlated Electrons (cond-mat.str-el)`, source: [`papers.cool/arxiv/cond-mat.str-el`], target: `/category/arxiv/cond-mat.str-el` },
            { title: `Superconductivity (cond-mat.supr-con)`, source: [`papers.cool/arxiv/cond-mat.supr-con`], target: `/category/arxiv/cond-mat.supr-con` },
            { title: `General Relativity and Quantum Cosmology (gr-qc)`, source: [`papers.cool/arxiv/gr-qc`], target: `/category/arxiv/gr-qc` },
            { title: `High Energy Physics - Experiment (hep-ex)`, source: [`papers.cool/arxiv/hep-ex`], target: `/category/arxiv/hep-ex` },
            { title: `High Energy Physics - Lattice (hep-lat)`, source: [`papers.cool/arxiv/hep-lat`], target: `/category/arxiv/hep-lat` },
            { title: `High Energy Physics - Phenomenology (hep-ph)`, source: [`papers.cool/arxiv/hep-ph`], target: `/category/arxiv/hep-ph` },
            { title: `High Energy Physics - Theory (hep-th)`, source: [`papers.cool/arxiv/hep-th`], target: `/category/arxiv/hep-th` },
            { title: `Mathematical Physics (math-ph)`, source: [`papers.cool/arxiv/math-ph`], target: `/category/arxiv/math-ph` },
            { title: `Nonlinear Sciences (nlin)`, source: [`papers.cool/arxiv/nlin`], target: `/category/arxiv/nlin` },
            { title: `Adaptation and Self-Organizing Systems (nlin.AO)`, source: [`papers.cool/arxiv/nlin.AO`], target: `/category/arxiv/nlin.AO` },
            { title: `Cellular Automata and Lattice Gases (nlin.CG)`, source: [`papers.cool/arxiv/nlin.CG`], target: `/category/arxiv/nlin.CG` },
            { title: `Chaotic Dynamics (nlin.CD)`, source: [`papers.cool/arxiv/nlin.CD`], target: `/category/arxiv/nlin.CD` },
            { title: `Exactly Solvable and Integrable Systems (nlin.SI)`, source: [`papers.cool/arxiv/nlin.SI`], target: `/category/arxiv/nlin.SI` },
            { title: `Pattern Formation and Solitons (nlin.PS)`, source: [`papers.cool/arxiv/nlin.PS`], target: `/category/arxiv/nlin.PS` },
            { title: `Nuclear Experiment (nucl-ex)`, source: [`papers.cool/arxiv/nucl-ex`], target: `/category/arxiv/nucl-ex` },
            { title: `Nuclear Theory (nucl-th)`, source: [`papers.cool/arxiv/nucl-th`], target: `/category/arxiv/nucl-th` },
            { title: `Physics (physics)`, source: [`papers.cool/arxiv/physics`], target: `/category/arxiv/physics` },
            { title: `Accelerator Physics (physics.acc-ph)`, source: [`papers.cool/arxiv/physics.acc-ph`], target: `/category/arxiv/physics.acc-ph` },
            { title: `Applied Physics (physics.app-ph)`, source: [`papers.cool/arxiv/physics.app-ph`], target: `/category/arxiv/physics.app-ph` },
            { title: `Atmospheric and Oceanic Physics (physics.ao-ph)`, source: [`papers.cool/arxiv/physics.ao-ph`], target: `/category/arxiv/physics.ao-ph` },
            { title: `Atomic and Molecular Clusters (physics.atm-clus)`, source: [`papers.cool/arxiv/physics.atm-clus`], target: `/category/arxiv/physics.atm-clus` },
            { title: `Atomic Physics (physics.atom-ph)`, source: [`papers.cool/arxiv/physics.atom-ph`], target: `/category/arxiv/physics.atom-ph` },
            { title: `Biological Physics (physics.bio-ph)`, source: [`papers.cool/arxiv/physics.bio-ph`], target: `/category/arxiv/physics.bio-ph` },
            { title: `Chemical Physics (physics.chem-ph)`, source: [`papers.cool/arxiv/physics.chem-ph`], target: `/category/arxiv/physics.chem-ph` },
            { title: `Classical Physics (physics.class-ph)`, source: [`papers.cool/arxiv/physics.class-ph`], target: `/category/arxiv/physics.class-ph` },
            { title: `Computational Physics (physics.comp-ph)`, source: [`papers.cool/arxiv/physics.comp-ph`], target: `/category/arxiv/physics.comp-ph` },
            { title: `Data Analysis, Statistics and Probability (physics.data-an)`, source: [`papers.cool/arxiv/physics.data-an`], target: `/category/arxiv/physics.data-an` },
            { title: `Fluid Dynamics (physics.flu-dyn)`, source: [`papers.cool/arxiv/physics.flu-dyn`], target: `/category/arxiv/physics.flu-dyn` },
            { title: `General Physics (physics.gen-ph)`, source: [`papers.cool/arxiv/physics.gen-ph`], target: `/category/arxiv/physics.gen-ph` },
            { title: `Geophysics (physics.geo-ph)`, source: [`papers.cool/arxiv/physics.geo-ph`], target: `/category/arxiv/physics.geo-ph` },
            { title: `History and Philosophy of Physics (physics.hist-ph)`, source: [`papers.cool/arxiv/physics.hist-ph`], target: `/category/arxiv/physics.hist-ph` },
            { title: `Instrumentation and Detectors (physics.ins-det)`, source: [`papers.cool/arxiv/physics.ins-det`], target: `/category/arxiv/physics.ins-det` },
            { title: `Medical Physics (physics.med-ph)`, source: [`papers.cool/arxiv/physics.med-ph`], target: `/category/arxiv/physics.med-ph` },
            { title: `Optics (physics.optics)`, source: [`papers.cool/arxiv/physics.optics`], target: `/category/arxiv/physics.optics` },
            { title: `Physics and Society (physics.soc-ph)`, source: [`papers.cool/arxiv/physics.soc-ph`], target: `/category/arxiv/physics.soc-ph` },
            { title: `Physics Education (physics.ed-ph)`, source: [`papers.cool/arxiv/physics.ed-ph`], target: `/category/arxiv/physics.ed-ph` },
            { title: `Plasma Physics (physics.plasm-ph)`, source: [`papers.cool/arxiv/physics.plasm-ph`], target: `/category/arxiv/physics.plasm-ph` },
            { title: `Popular Physics (physics.pop-ph)`, source: [`papers.cool/arxiv/physics.pop-ph`], target: `/category/arxiv/physics.pop-ph` },
            { title: `Space Physics (physics.space-ph)`, source: [`papers.cool/arxiv/physics.space-ph`], target: `/category/arxiv/physics.space-ph` },
            { title: `Quantum Physics (quant-ph)`, source: [`papers.cool/arxiv/quant-ph`], target: `/category/arxiv/quant-ph` },
            { title: `Mathematics (math)`, source: [`papers.cool/arxiv/math`], target: `/category/arxiv/math` },
            { title: `Algebraic Geometry (math.AG)`, source: [`papers.cool/arxiv/math.AG`], target: `/category/arxiv/math.AG` },
            { title: `Algebraic Topology (math.AT)`, source: [`papers.cool/arxiv/math.AT`], target: `/category/arxiv/math.AT` },
            { title: `Analysis of PDEs (math.AP)`, source: [`papers.cool/arxiv/math.AP`], target: `/category/arxiv/math.AP` },
            { title: `Category Theory (math.CT)`, source: [`papers.cool/arxiv/math.CT`], target: `/category/arxiv/math.CT` },
            { title: `Classical Analysis and ODEs (math.CA)`, source: [`papers.cool/arxiv/math.CA`], target: `/category/arxiv/math.CA` },
            { title: `Combinatorics (math.CO)`, source: [`papers.cool/arxiv/math.CO`], target: `/category/arxiv/math.CO` },
            { title: `Commutative Algebra (math.AC)`, source: [`papers.cool/arxiv/math.AC`], target: `/category/arxiv/math.AC` },
            { title: `Complex Variables (math.CV)`, source: [`papers.cool/arxiv/math.CV`], target: `/category/arxiv/math.CV` },
            { title: `Differential Geometry (math.DG)`, source: [`papers.cool/arxiv/math.DG`], target: `/category/arxiv/math.DG` },
            { title: `Dynamical Systems (math.DS)`, source: [`papers.cool/arxiv/math.DS`], target: `/category/arxiv/math.DS` },
            { title: `Functional Analysis (math.FA)`, source: [`papers.cool/arxiv/math.FA`], target: `/category/arxiv/math.FA` },
            { title: `General Mathematics (math.GM)`, source: [`papers.cool/arxiv/math.GM`], target: `/category/arxiv/math.GM` },
            { title: `General Topology (math.GN)`, source: [`papers.cool/arxiv/math.GN`], target: `/category/arxiv/math.GN` },
            { title: `Geometric Topology (math.GT)`, source: [`papers.cool/arxiv/math.GT`], target: `/category/arxiv/math.GT` },
            { title: `Group Theory (math.GR)`, source: [`papers.cool/arxiv/math.GR`], target: `/category/arxiv/math.GR` },
            { title: `History and Overview (math.HO)`, source: [`papers.cool/arxiv/math.HO`], target: `/category/arxiv/math.HO` },
            { title: `Information Theory (math.IT)`, source: [`papers.cool/arxiv/math.IT`], target: `/category/arxiv/math.IT` },
            { title: `K-Theory and Homology (math.KT)`, source: [`papers.cool/arxiv/math.KT`], target: `/category/arxiv/math.KT` },
            { title: `Logic (math.LO)`, source: [`papers.cool/arxiv/math.LO`], target: `/category/arxiv/math.LO` },
            { title: `Mathematical Physics (math.MP)`, source: [`papers.cool/arxiv/math.MP`], target: `/category/arxiv/math.MP` },
            { title: `Metric Geometry (math.MG)`, source: [`papers.cool/arxiv/math.MG`], target: `/category/arxiv/math.MG` },
            { title: `Number Theory (math.NT)`, source: [`papers.cool/arxiv/math.NT`], target: `/category/arxiv/math.NT` },
            { title: `Numerical Analysis (math.NA)`, source: [`papers.cool/arxiv/math.NA`], target: `/category/arxiv/math.NA` },
            { title: `Operator Algebras (math.OA)`, source: [`papers.cool/arxiv/math.OA`], target: `/category/arxiv/math.OA` },
            { title: `Optimization and Control (math.OC)`, source: [`papers.cool/arxiv/math.OC`], target: `/category/arxiv/math.OC` },
            { title: `Probability (math.PR)`, source: [`papers.cool/arxiv/math.PR`], target: `/category/arxiv/math.PR` },
            { title: `Quantum Algebra (math.QA)`, source: [`papers.cool/arxiv/math.QA`], target: `/category/arxiv/math.QA` },
            { title: `Representation Theory (math.RT)`, source: [`papers.cool/arxiv/math.RT`], target: `/category/arxiv/math.RT` },
            { title: `Rings and Algebras (math.RA)`, source: [`papers.cool/arxiv/math.RA`], target: `/category/arxiv/math.RA` },
            { title: `Spectral Theory (math.SP)`, source: [`papers.cool/arxiv/math.SP`], target: `/category/arxiv/math.SP` },
            { title: `Statistics Theory (math.ST)`, source: [`papers.cool/arxiv/math.ST`], target: `/category/arxiv/math.ST` },
            { title: `Symplectic Geometry (math.SG)`, source: [`papers.cool/arxiv/math.SG`], target: `/category/arxiv/math.SG` },
            { title: `Computer Science (cs)`, source: [`papers.cool/arxiv/cs`], target: `/category/arxiv/cs` },
            { title: `Artificial Intelligence (cs.AI)`, source: [`papers.cool/arxiv/cs.AI`], target: `/category/arxiv/cs.AI` },
            { title: `Computation and Language (cs.CL)`, source: [`papers.cool/arxiv/cs.CL`], target: `/category/arxiv/cs.CL` },
            { title: `Computational Complexity (cs.CC)`, source: [`papers.cool/arxiv/cs.CC`], target: `/category/arxiv/cs.CC` },
            { title: `Computational Engineering, Finance, and Science (cs.CE)`, source: [`papers.cool/arxiv/cs.CE`], target: `/category/arxiv/cs.CE` },
            { title: `Computational Geometry (cs.CG)`, source: [`papers.cool/arxiv/cs.CG`], target: `/category/arxiv/cs.CG` },
            { title: `Computer Science and Game Theory (cs.GT)`, source: [`papers.cool/arxiv/cs.GT`], target: `/category/arxiv/cs.GT` },
            { title: `Computer Vision and Pattern Recognition (cs.CV)`, source: [`papers.cool/arxiv/cs.CV`], target: `/category/arxiv/cs.CV` },
            { title: `Computers and Society (cs.CY)`, source: [`papers.cool/arxiv/cs.CY`], target: `/category/arxiv/cs.CY` },
            { title: `Cryptography and Security (cs.CR)`, source: [`papers.cool/arxiv/cs.CR`], target: `/category/arxiv/cs.CR` },
            { title: `Data Structures and Algorithms (cs.DS)`, source: [`papers.cool/arxiv/cs.DS`], target: `/category/arxiv/cs.DS` },
            { title: `Databases (cs.DB)`, source: [`papers.cool/arxiv/cs.DB`], target: `/category/arxiv/cs.DB` },
            { title: `Digital Libraries (cs.DL)`, source: [`papers.cool/arxiv/cs.DL`], target: `/category/arxiv/cs.DL` },
            { title: `Discrete Mathematics (cs.DM)`, source: [`papers.cool/arxiv/cs.DM`], target: `/category/arxiv/cs.DM` },
            { title: `Distributed, Parallel, and Cluster Computing (cs.DC)`, source: [`papers.cool/arxiv/cs.DC`], target: `/category/arxiv/cs.DC` },
            { title: `Emerging Technologies (cs.ET)`, source: [`papers.cool/arxiv/cs.ET`], target: `/category/arxiv/cs.ET` },
            { title: `Formal Languages and Automata Theory (cs.FL)`, source: [`papers.cool/arxiv/cs.FL`], target: `/category/arxiv/cs.FL` },
            { title: `General Literature (cs.GL)`, source: [`papers.cool/arxiv/cs.GL`], target: `/category/arxiv/cs.GL` },
            { title: `Graphics (cs.GR)`, source: [`papers.cool/arxiv/cs.GR`], target: `/category/arxiv/cs.GR` },
            { title: `Hardware Architecture (cs.AR)`, source: [`papers.cool/arxiv/cs.AR`], target: `/category/arxiv/cs.AR` },
            { title: `Human-Computer Interaction (cs.HC)`, source: [`papers.cool/arxiv/cs.HC`], target: `/category/arxiv/cs.HC` },
            { title: `Information Retrieval (cs.IR)`, source: [`papers.cool/arxiv/cs.IR`], target: `/category/arxiv/cs.IR` },
            { title: `Information Theory (cs.IT)`, source: [`papers.cool/arxiv/cs.IT`], target: `/category/arxiv/cs.IT` },
            { title: `Logic in Computer Science (cs.LO)`, source: [`papers.cool/arxiv/cs.LO`], target: `/category/arxiv/cs.LO` },
            { title: `Machine Learning (cs.LG)`, source: [`papers.cool/arxiv/cs.LG`], target: `/category/arxiv/cs.LG` },
            { title: `Mathematical Software (cs.MS)`, source: [`papers.cool/arxiv/cs.MS`], target: `/category/arxiv/cs.MS` },
            { title: `Multiagent Systems (cs.MA)`, source: [`papers.cool/arxiv/cs.MA`], target: `/category/arxiv/cs.MA` },
            { title: `Multimedia (cs.MM)`, source: [`papers.cool/arxiv/cs.MM`], target: `/category/arxiv/cs.MM` },
            { title: `Networking and Internet Architecture (cs.NI)`, source: [`papers.cool/arxiv/cs.NI`], target: `/category/arxiv/cs.NI` },
            { title: `Neural and Evolutionary Computing (cs.NE)`, source: [`papers.cool/arxiv/cs.NE`], target: `/category/arxiv/cs.NE` },
            { title: `Numerical Analysis (cs.NA)`, source: [`papers.cool/arxiv/cs.NA`], target: `/category/arxiv/cs.NA` },
            { title: `Operating Systems (cs.OS)`, source: [`papers.cool/arxiv/cs.OS`], target: `/category/arxiv/cs.OS` },
            { title: `Other Computer Science (cs.OH)`, source: [`papers.cool/arxiv/cs.OH`], target: `/category/arxiv/cs.OH` },
            { title: `Performance (cs.PF)`, source: [`papers.cool/arxiv/cs.PF`], target: `/category/arxiv/cs.PF` },
            { title: `Programming Languages (cs.PL)`, source: [`papers.cool/arxiv/cs.PL`], target: `/category/arxiv/cs.PL` },
            { title: `Robotics (cs.RO)`, source: [`papers.cool/arxiv/cs.RO`], target: `/category/arxiv/cs.RO` },
            { title: `Social and Information Networks (cs.SI)`, source: [`papers.cool/arxiv/cs.SI`], target: `/category/arxiv/cs.SI` },
            { title: `Software Engineering (cs.SE)`, source: [`papers.cool/arxiv/cs.SE`], target: `/category/arxiv/cs.SE` },
            { title: `Sound (cs.SD)`, source: [`papers.cool/arxiv/cs.SD`], target: `/category/arxiv/cs.SD` },
            { title: `Symbolic Computation (cs.SC)`, source: [`papers.cool/arxiv/cs.SC`], target: `/category/arxiv/cs.SC` },
            { title: `Systems and Control (cs.SY)`, source: [`papers.cool/arxiv/cs.SY`], target: `/category/arxiv/cs.SY` },
            { title: `Quantitative Biology (q-bio)`, source: [`papers.cool/arxiv/q-bio`], target: `/category/arxiv/q-bio` },
            { title: `Biomolecules (q-bio.BM)`, source: [`papers.cool/arxiv/q-bio.BM`], target: `/category/arxiv/q-bio.BM` },
            { title: `Cell Behavior (q-bio.CB)`, source: [`papers.cool/arxiv/q-bio.CB`], target: `/category/arxiv/q-bio.CB` },
            { title: `Genomics (q-bio.GN)`, source: [`papers.cool/arxiv/q-bio.GN`], target: `/category/arxiv/q-bio.GN` },
            { title: `Molecular Networks (q-bio.MN)`, source: [`papers.cool/arxiv/q-bio.MN`], target: `/category/arxiv/q-bio.MN` },
            { title: `Neurons and Cognition (q-bio.NC)`, source: [`papers.cool/arxiv/q-bio.NC`], target: `/category/arxiv/q-bio.NC` },
            { title: `Other Quantitative Biology (q-bio.OT)`, source: [`papers.cool/arxiv/q-bio.OT`], target: `/category/arxiv/q-bio.OT` },
            { title: `Populations and Evolution (q-bio.PE)`, source: [`papers.cool/arxiv/q-bio.PE`], target: `/category/arxiv/q-bio.PE` },
            { title: `Quantitative Methods (q-bio.QM)`, source: [`papers.cool/arxiv/q-bio.QM`], target: `/category/arxiv/q-bio.QM` },
            { title: `Subcellular Processes (q-bio.SC)`, source: [`papers.cool/arxiv/q-bio.SC`], target: `/category/arxiv/q-bio.SC` },
            { title: `Tissues and Organs (q-bio.TO)`, source: [`papers.cool/arxiv/q-bio.TO`], target: `/category/arxiv/q-bio.TO` },
            { title: `Quantitative Finance (q-fin)`, source: [`papers.cool/arxiv/q-fin`], target: `/category/arxiv/q-fin` },
            { title: `Computational Finance (q-fin.CP)`, source: [`papers.cool/arxiv/q-fin.CP`], target: `/category/arxiv/q-fin.CP` },
            { title: `Economics (q-fin.EC)`, source: [`papers.cool/arxiv/q-fin.EC`], target: `/category/arxiv/q-fin.EC` },
            { title: `General Finance (q-fin.GN)`, source: [`papers.cool/arxiv/q-fin.GN`], target: `/category/arxiv/q-fin.GN` },
            { title: `Mathematical Finance (q-fin.MF)`, source: [`papers.cool/arxiv/q-fin.MF`], target: `/category/arxiv/q-fin.MF` },
            { title: `Portfolio Management (q-fin.PM)`, source: [`papers.cool/arxiv/q-fin.PM`], target: `/category/arxiv/q-fin.PM` },
            { title: `Pricing of Securities (q-fin.PR)`, source: [`papers.cool/arxiv/q-fin.PR`], target: `/category/arxiv/q-fin.PR` },
            { title: `Risk Management (q-fin.RM)`, source: [`papers.cool/arxiv/q-fin.RM`], target: `/category/arxiv/q-fin.RM` },
            { title: `Statistical Finance (q-fin.ST)`, source: [`papers.cool/arxiv/q-fin.ST`], target: `/category/arxiv/q-fin.ST` },
            { title: `Trading and Market Microstructure (q-fin.TR)`, source: [`papers.cool/arxiv/q-fin.TR`], target: `/category/arxiv/q-fin.TR` },
            { title: `Statistics (stat)`, source: [`papers.cool/arxiv/stat`], target: `/category/arxiv/stat` },
            { title: `Applications (stat.AP)`, source: [`papers.cool/arxiv/stat.AP`], target: `/category/arxiv/stat.AP` },
            { title: `Computation (stat.CO)`, source: [`papers.cool/arxiv/stat.CO`], target: `/category/arxiv/stat.CO` },
            { title: `Machine Learning (stat.ML)`, source: [`papers.cool/arxiv/stat.ML`], target: `/category/arxiv/stat.ML` },
            { title: `Methodology (stat.ME)`, source: [`papers.cool/arxiv/stat.ME`], target: `/category/arxiv/stat.ME` },
            { title: `Other Statistics (stat.OT)`, source: [`papers.cool/arxiv/stat.OT`], target: `/category/arxiv/stat.OT` },
            { title: `Statistics Theory (stat.TH)`, source: [`papers.cool/arxiv/stat.TH`], target: `/category/arxiv/stat.TH` },
            { title: `Electrical Engineering and Systems Science (eess)`, source: [`papers.cool/arxiv/eess`], target: `/category/arxiv/eess` },
            { title: `Audio and Speech Processing (eess.AS)`, source: [`papers.cool/arxiv/eess.AS`], target: `/category/arxiv/eess.AS` },
            { title: `Image and Video Processing (eess.IV)`, source: [`papers.cool/arxiv/eess.IV`], target: `/category/arxiv/eess.IV` },
            { title: `Signal Processing (eess.SP)`, source: [`papers.cool/arxiv/eess.SP`], target: `/category/arxiv/eess.SP` },
            { title: `Systems and Control (eess.SY)`, source: [`papers.cool/arxiv/eess.SY`], target: `/category/arxiv/eess.SY` },
            { title: `Economics (econ)`, source: [`papers.cool/arxiv/econ`], target: `/category/arxiv/econ` },
            { title: `Econometrics (econ.EM)`, source: [`papers.cool/arxiv/econ.EM`], target: `/category/arxiv/econ.EM` },
            { title: `General Economics (econ.GN)`, source: [`papers.cool/arxiv/econ.GN`], target: `/category/arxiv/econ.GN` },
            { title: `Theoretical Economics (econ.TH)`, source: [`papers.cool/arxiv/econ.TH`], target: `/category/arxiv/econ.TH` },
        ],
        view: r.Articles,
        zh: {
            path: `/category/:id{.+}?`,
            ...
            parameters: { id: { description: `分类 id，可在对应分类页 URL 中找到` } },
            description:
