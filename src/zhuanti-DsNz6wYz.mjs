...
async function l(c) {
    let l = c.req.param(`id`),
        ...
        d = new URL(`zhuanti/${l}.html`, a).href,
        { data: f } = await n(d),
        p = s(f),
        m = p(`div.tips h2`).first().text(),
    ...
    return { item: await o(u, e.tryGet, h), title: `爱思想 - ${m}`, link: d, description: p(`div.tips p`).text(), language: `zh-cn`, image: new URL(`images/logo_zhuanti.jpg`, i).href, subtitle: m };
}
export { c as route };
