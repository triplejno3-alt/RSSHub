...
const i = async (i) => {
        let { channel: a = `allrules/bussiness` } = i.req.param(),
            o = i.req.query(`limit`) ? Number.parseInt(i.req.query(`limit`), 10) : 30,
            s = `https://www.szse.cn`,
            c = new URL(`api/search/content`, s).href,
            l = new URL(`www/lawrules/rule/${a}/`, s).href,
            { data: u } = await n(l),
            d = r(u),
            f = d(`ul.side-menu-con li.active`).last(),
            p = f.prop(`chnlcode`),
            { data: m } = await n.post(c, { form: { keyword: ``, time: 0, range: `title`, 'channelCode[]': p, currentPage: 1, pageSize: o, scope: 0 } }),
            h = m.data.slice(0, o).map((e) => ({ title: e.doctitle, pubDate: t(e.docpubtime, `X`), link: e.docpuburl, category: e.navigation }));
        h = await Promise.all(
            h.map((i) =>
                e.tryGet(i.link, async () => {
                    let { data: e } = await n(i.link),
                        a = r(e),
                        o = a(`h2.title`).text(),
                        s = a(`div#desContent`).html();
                    return (
                        (i.title = o),
                        (i.description = s),
                        (i.pubDate = i.pubDate ?? t(a(`div.time span`).text())),
                        (i.author = a(`meta[name="author"]`).prop(`content`)),
                        (i.content = { html: s, text: a(`div#desContent`).text() }),
                        (i.language = a(`html`).prop(`lang`)),
                        i
                    );
                })
            )
        );
        let g = d(`a.navbar-brand img`).prop(`src`);
        return {
            title: `深圳证券交易所 - ${f.text()}`,
        ...
        radar: [
            {
                ...
                target: (e) => {
                    let t = e.category;
                    return `/szse/rule${t ? `/${t}` : ``}`;
                },
            },
            { title: `综合类`, source: [`www.szse.cn/www/lawrules/rule/all/index.html`], target: `/rule/all` },
            { title: `基础设施REITs类`, source: [`www.szse.cn/www/lawrules/rule/reits/index.html`], target: `/rule/reits` },
            { title: `衍生品类`, source: [`www.szse.cn/www/lawrules/rule/derivative/index.html`], target: `/rule/derivative` },
            { title: `会员管理类`, source: [`www.szse.cn/www/lawrules/rule/memberty/index.html`], target: `/rule/memberty` },
            { title: `纪律处分与内部救济类`, source: [`www.szse.cn/www/lawrules/rule/pr/index.html`], target: `/rule/pr` },
            { title: `股票类 - 发行上市审核`, source: [`www.szse.cn/www/lawrules/rule/stock/audit/index.html`], target: `/rule/stock/audit` },
            { title: `股票类 - 发行承销`, source: [`www.szse.cn/www/lawrules/rule/stock/issue/index.html`], target: `/rule/stock/issue` },
            { title: `股票类 - 通用`, source: [`www.szse.cn/www/lawrules/rule/stock/supervision/currency/index.html`], target: `/rule/stock/supervision/currency` },
            { title: `股票类 - 主板专用`, source: [`www.szse.cn/www/lawrules/rule/stock/supervision/mb/index.html`], target: `/rule/stock/supervision/mb` },
            { title: `股票类 - 创业板专用`, source: [`www.szse.cn/www/lawrules/rule/stock/supervision/chinext/index.html`], target: `/rule/stock/supervision/chinext` },
            { title: `股票类 - 交易`, source: [`www.szse.cn/www/lawrules/rule/stock/trade/index.html`], target: `/rule/stock/trade` },
            { title: `固收类 - 发行上市（挂牌）`, source: [`www.szse.cn/www/lawrules/rule/bond/bonds/list/index.html`], target: `/rule/bond/bonds/list` },
            { title: `固收类 - 持续监管`, source: [`www.szse.cn/www/lawrules/rule/bond/bonds/supervision/index.html`], target: `/rule/bond/bonds/supervision` },
            { title: `固收类 - 交易`, source: [`www.szse.cn/www/lawrules/rule/bond/bonds/trade/index.html`], target: `/rule/bond/bonds/trade` },
            { title: `固收类 - 资产支持证券`, source: [`www.szse.cn/www/lawrules/rule/bond/abs/index.html`], target: `/rule/bond/abs` },
            { title: `基金类 - 上市`, source: [`www.szse.cn/www/lawrules/rule/fund/list/index.html`], target: `/rule/fund/list` },
            { title: `基金类 - 交易`, source: [`www.szse.cn/www/lawrules/rule/fund/trade/index.html`], target: `/rule/fund/trade` },
            { title: `交易类 - 通用`, source: [`www.szse.cn/www/lawrules/rule/trade/current/index.html`], target: `/rule/trade/current` },
            { title: `交易类 - 融资融券`, source: [`www.szse.cn/www/lawrules/rule/trade/business/margin/index.html`], target: `/rule/trade/business/margin` },
            { title: `交易类 - 转融通`, source: [`www.szse.cn/www/lawrules/rule/trade/business/refinancing/index.html`], target: `/rule/trade/business/refinancing` },
            { title: `交易类 - 股票质押式回购`, source: [`www.szse.cn/www/lawrules/rule/trade/business/pledge/index.html`], target: `/rule/trade/business/pledge` },
            { title: `交易类 - 质押式报价回购`, source: [`www.szse.cn/www/lawrules/rule/trade/business/price/index.html`], target: `/rule/trade/business/price` },
            { title: `交易类 - 约定购回`, source: [`www.szse.cn/www/lawrules/rule/trade/business/promise/index.html`], target: `/rule/trade/business/promise` },
            { title: `交易类 - 协议转让`, source: [`www.szse.cn/www/lawrules/rule/trade/business/transfer/index.html`], target: `/rule/trade/business/transfer` },
            { title: `交易类 - 其他`, source: [`www.szse.cn/www/lawrules/rule/trade/business/oth/index.html`], target: `/rule/trade/business/oth` },
            { title: `跨境创新类 - 深港通`, source: [`www.szse.cn/www/lawrules/rule/inno/szhk/index.html`], target: `/rule/inno/szhk` },
            { title: `跨境创新类 - 试点创新企业`, source: [`www.szse.cn/www/lawrules/rule/inno/pilot/index.html`], target: `/rule/inno/pilot` },
            { title: `跨境创新类 - H股全流通`, source: [`www.szse.cn/www/lawrules/rule/inno/hc/index.html`], target: `/rule/inno/hc` },
            { title: `跨境创新类 - 互联互通存托凭证`, source: [`www.szse.cn/www/lawrules/rule/inno/gdr/index.html`], target: `/rule/inno/gdr` },
            { title: `全部规则 - 全部业务规则`, source: [`www.szse.cn/www/lawrules/rule/allrules/bussiness/index.html`], target: `/rule/allrules/bussiness` },
            { title: `全部规则 - 规则汇编下载`, source: [`www.szse.cn/www/lawrules/rule/allrules/rulejoin/index.html`], target: `/rule/allrules/rulejoin` },
            { title: `已废止规则 - 规则废止公告`, source: [`www.szse.cn/www/lawrules/rule/repeal/announcement/index.html`], target: `/rule/repeal/announcement` },
            { title: `已废止规则 - 已废止规则文本`, source: [`www.szse.cn/www/lawrules/rule/repeal/rules/index.html`], target: `/rule/repeal/rules` },
        ],
    };
